...
(function (a) {
  ...
  a.extend(a.jqx._jqxMenu.prototype, {
        ...
        if (this.keyboardNavigation) {
          ...
          var e = function () {
            if (!a.jqx.isHidden(a(c.items[0].element))) {
              a(c.items[0].element).addClass(
                c.toThemeProperty("jqx-fill-state-focus")
              );
              c.activeItem = c.items[0];
            } else {
              var f = c._nextVisibleItem(c.items[0], 0);
              if (f) {
                a(f.element).addClass(
                  c.toThemeProperty("jqx-fill-state-focus")
                );
                c.activeItem = f;
              }
          ...
          if (!this.activeItem) {
            ...
            if (!a.jqx.isHidden(a(this.activeItem.element))) {
              a(this.activeItem.element).addClass(
                this.toThemeProperty("jqx-fill-state-focus")
              );
            } else {
              a(this.activeItem.element).removeClass(
                this.toThemeProperty("jqx-fill-state-focus")
              );
              e();
            }
        ...
        if (!a.jqx.response) {
          ...
          if (navigator.userAgent.match(/Windows|Linux|MacOS/)) {
            var b =
              ...
              navigator.userAgent.indexOf("WPDesktop") >= 0 ||
              navigator.userAgent.indexOf("IEMobile") >= 0 ||
              navigator.userAgent.indexOf("ZuneWP7") >= 0;
            if (!b) {
              e = true;
            }
          }
    ...
    minimize: function () {
      ...
      c.wrap(
        '<div class="jqx-menu-wrapper" style="z-index:' +
          this.popupZIndex +
        ...
        h.animate(
          {
            left: !i
              ? -h.outerWidth()
              : e.host.coord().left + e.host.width() + h.width(),
            opacity: 0,
          },
          e.animationHideDuration,
          function () {
          ...
          h.animate(
            {
              left: !j
                ? e.host.coord().left
                : e.host.coord().left + e.host.width() - i,
              opacity: 0.95,
            },
            e.animationShowDuration,
            function () {}
          );
        } else {
          b(k);
      ...
      this.addHandler(
        a(window),
        "orientationchange.jqxmenu" + this.element.id,
        function (i) {
          setTimeout(function () {
            if (!e.minimizedHidden) {
              var j = h.width();
              ...
              h.css({
                left: !k
                  ? e.host.coord().left
                  : e.host.coord().left + e.host.width() - j,
              });
            }
          }, 25);
        }
    ...
    restore: function () {
      ...
      this.host
        .find("ul")
        .removeClass(this.toThemeProperty("jqx-menu-ul-minimized"));
        ...
        var n = function () {
          ...
          if (b) {
            j.stop().animate({ top: m }, l.animationHideDuration, function () {
              a(o.element).removeClass(
                l.toThemeProperty("jqx-fill-state-pressed")
              );
              a(o.element).removeClass(
                l.toThemeProperty("jqx-menu-item-top-selected")
              );
            ...
            j.stop().animate({ left: e }, l.animationHideDuration, function () {
              ...
              if (o.level > 0) {
                ...
                a(o.element).removeClass(
                  l.toThemeProperty("jqx-menu-item-selected")
                );
                var p = a(o.arrow);
                if (p.length > 0) {
                  p.removeClass();
                  if (o.openHorizontalDirection != "left") {
                    p.addClass(
                      l.toThemeProperty(
                        "jqx-menu-item-arrow-" + l._getDir("right")
                      )
                    );
                    p.addClass(
                      l.toThemeProperty("jqx-icon-arrow-" + l._getDir("right"))
                    );
                  } else {
                    p.addClass(
                      l.toThemeProperty(
                        "jqx-menu-item-arrow-" + l._getDir("left")
                      )
                    );
                    p.addClass(
                      l.toThemeProperty("jqx-icon-arrow-" + l._getDir("left"))
                    );
                  }
                }
              } else {
                ...
                if (p.length > 0) {
                  ...
                  if (o.openHorizontalDirection != "left") {
                    p.addClass(
                      l.toThemeProperty(
                        "jqx-menu-item-arrow-top-" + l._getDir("right")
                      )
                    );
                    p.addClass(
                      l.toThemeProperty("jqx-icon-arrow-" + l._getDir("right"))
                    ...
                    p.addClass(
                      l.toThemeProperty(
                        "jqx-menu-item-arrow-top-" + l._getDir("left")
                      )
                    );
                    p.addClass(
                      l.toThemeProperty("jqx-icon-arrow-" + l._getDir("left"))
          ...
          if (i.hasItems && i.level > 0) {
            ...
            if (h != undefined) {
              ...
              if (i.openHorizontalDirection == "left") {
                b.addClass(
                  g.toThemeProperty("jqx-menu-item-arrow-" + g._getDir("left"))
                );
                b.addClass(
                  g.toThemeProperty("jqx-icon-arrow-" + g._getDir("left"))
                );
              } else {
                b.addClass(
                  g.toThemeProperty("jqx-menu-item-arrow-" + g._getDir("right"))
                );
                b.addClass(
                  g.toThemeProperty("jqx-icon-arrow-" + g._getDir("right"))
                );
              }
    ...
    _openItem: function (s, r, q) {
      ...
      if (r.level > 0 && this.hasTransform) {
        var p =
          parseInt(h.coord().top) - parseInt(this._getOffset(r.element).top);
        i.top += p;
      }
      ...
      var b = j
        ? i.left
        : this.menuElements[r.parentId] != null &&
          this.menuElements[r.parentId].subMenuElement != null
        ? parseInt(
            a(
              a(this.menuElements[r.parentId].subMenuElement).closest(
                "div.jqx-menu-popup"
              )
            ).outerWidth()
          ) - f[0]
      ...
      switch (r.openHorizontalDirection) {
        ...
        case "center":
          if (j) {
            o.css({
              left:
                i.left - (o.outerWidth() / 2 - h.outerWidth() / 2 - f[0] / 2),
            });
          } else {
            o.css({
              left:
          ...
          if (o != null) {
            if (j) {
              ...
              if (u.length > 0 && s.showTopLevelArrows) {
                ...
                if (r.openVerticalDirection == "down") {
                  u.addClass(
                    s.toThemeProperty("jqx-menu-item-arrow-down-selected")
                  );
                  u.addClass(s.toThemeProperty("jqx-icon-arrow-down"));
                } else {
                  u.addClass(
                    s.toThemeProperty("jqx-menu-item-arrow-up-selected")
                  );
              ...
              if (r.level > 0) {
                ...
                if (u.length > 0) {
                  ...
                  if (r.openHorizontalDirection != "left") {
                    ...
                    u.addClass(
                      s.toThemeProperty("jqx-icon-arrow-" + s._getDir("right"))
                    );
                  } else {
                    u.addClass(
                      s.toThemeProperty(
                        "jqx-menu-item-arrow-" + s._getDir("left") + "-selected"
                      )
                    );
                    u.addClass(
                      s.toThemeProperty("jqx-icon-arrow-" + s._getDir("left"))
                    );
                  }
                }
              } else {
    ...
    _applyOrientation: function (i, d) {
      ...
      if (i != undefined && d != undefined && d == "popup") {
        if (
          g.host.parent().length > 0 &&
          g.host.parent().parent().length > 0 &&
          g.host.parent().parent()[0] == document.body
        ) {
      ...
      if (g.autoOpenPopup) {
        ...
        g.addHandler(a(document), "contextmenu." + g.element.id, function (j) {
          if (
            j.target &&
            j.target.className.indexOf &&
            j.target.className.indexOf("jqx-menu") >= 0
          ) {
            return false;
          }
        });
        ...
        case "horizontal":
          ...
          a.each(g.items, function () {
            ...
            if (m.hasItems && m.level > 0) {
              var l = a(
                '<span style="border: none; background-color: transparent;" id="arrow' +
                  k[0].id +
                  '"></span>'
              );
              l.prependTo(k);
          ...
          a.each(g.items, function () {
            ...
            if (l.hasItems && !l.ignoretheme) {
              ...
              if (l.level == 0) {
                k.addClass(
                  g.toThemeProperty(
                    "jqx-menu-item-arrow-top-" + g._getDir("right")
                  )
                );
                k.addClass(
                  g.toThemeProperty("jqx-icon-arrow-" + g._getDir("right"))
    ...
    _render: function (f, g) {
        ...
        if (
          ...
          if (navigator.userAgent.indexOf("Touch") >= 0) {
            ...
            if (
              b ||
              a.jqx.mobile.isWindowsPhone() ||
              navigator.userAgent.indexOf("ARM") >= 0
            ) {
              j = true;
              c = true;
              h.clickToOpen = true;
          ...
          if (h.activeItem) {
            if (h.mode === "popup") {
              if (
                ...
                document.activeElement.className.indexOf("jqx-menu-wrapper") >=
                  0
              ) {
                return;
              }
            }
            a(h.activeItem.element).removeClass(
              h.toThemeProperty("jqx-fill-state-focus")
            );
            h.activeItem = null;
          }
        }
      ...
      this.addHandler(this.host, "focus", function (k) {
        if (h.keyboardNavigation) {
          if (!h.activeItem) {
            if (h.hoveredItem) {
              a(h.hoveredItem.element).addClass(
                h.toThemeProperty("jqx-fill-state-focus")
              );
              ...
              if (!h.activeItem) {
                ...
                if (!a.jqx.isHidden(a(h.activeItem.element))) {
                  a(h.activeItem.element).addClass(
                    h.toThemeProperty("jqx-fill-state-focus")
                  );
                } else {
                  a(h.activeItem.element).removeClass(
      ...
      h.handleKeyDown = function (k) {
        if (h.keyboardNavigation) {
          ...
          if (v === "right" && !h.minimized) {
            if (
              k.altKey &&
              ((q.level != 0 && q.hasItems) || h.mode != "horizontal")
            ) {
              h._openItem(h, q);
            } else {
              ...
              if (
                x &&
                ((x.parentId === q.parentId &&
                  x.level == 0 &&
                  h.mode == "horizontal") ||
                  (m.id == w[0].id && m.level != 0))
              ) {
                if (
                  m.id == w[0].id &&
                  (q.level != 0 || (q.level == 0 && h.mode != "horizontal"))
                ) {
                  x = m;
                }
                a(x.element).addClass(
                  h.toThemeProperty("jqx-fill-state-focus")
                );
                a(q.element).removeClass(
                  h.toThemeProperty("jqx-fill-state-focus")
                );
                h.activeItem = x;
              }
          ...
          if (v === "left" && !h.minimized) {
            if (
              k.altKey &&
              ((q.level != 0 && h.mode !== "horizontal") ||
                (q.level > 1 && h.mode === "horizontal") ||
                (q.level == 1 && q.hasItems && h.mode === "horizontal"))
            ) {
              if (q.hasItems) {
                h._closeItem(h, q);
              } else {
                if (q.parentItem) {
                  ...
                  a(q.parentItem.element).addClass(
                    h.toThemeProperty("jqx-fill-state-focus")
                  );
                  a(q.element).removeClass(
                    h.toThemeProperty("jqx-fill-state-focus")
              ...
              if (
                ...
                if (
                  !(y && y.level == 0 && h.mode == "horizontal") &&
                  y &&
                  y.level == q.level - 1
                ) {
                  a(y.element).addClass(
                    h.toThemeProperty("jqx-fill-state-focus")
                  );
                  a(q.element).removeClass(
                    h.toThemeProperty("jqx-fill-state-focus")
          ...
          if (k.keyCode == 9) {
            ...
            if (x) {
              ...
              if (h.lockFocus) {
                ...
                if (w.length > 0) {
                  if (k.shiftKey) {
                    a(w[w.length - 1].element).addClass(
                      h.toThemeProperty("jqx-fill-state-focus")
                    );
                    h.activeItem = w[w.length - 1];
                  } else {
                    a(w[0].element).addClass(
                      h.toThemeProperty("jqx-fill-state-focus")
                    );
                    h.activeItem = w[0];
                  }
      ...
      a.each(this.items, function () {
        ...
        if (r.subMenuElement != null) {
          ...
          var q = a(r.subMenuElement)
            ...
            .css({
              width:
                parseInt(a(r.subMenuElement).outerWidth()) +
                parseInt(d[0]) +
                "px",
              height:
                parseInt(a(r.subMenuElement).outerHeight()) +
                parseInt(d[1]) +
                "px",
            });
    ...
    _createMenu: function (c, f) {
      ...
      for (var j = 0; j < u.length; j++) {
        ...
        var s = a(m);
        if (
          m.className.indexOf("jqx-menu") == -1 &&
        ...
        h.each(function () {
          if (!f) {
            ...
            if (x.autoGenerate) {
              ...
              if (!x.minimized) {
                a(x.items[q - 1].subMenuElement).addClass(
                  x.toThemeProperty("jqx-widget-content")
                );
              }
              a(x.items[q - 1].subMenuElement).addClass(
                x.toThemeProperty("jqx-menu-dropdown")
              );
              a(x.items[q - 1].subMenuElement).addClass(
                x.toThemeProperty("jqx-popup")
              );
            }
          }
        ...
        var b =
          m.getAttribute("ignoretheme") || m.getAttribute("data-ignoretheme");
        if (b) {
          if (b == "true" || b == true) {
            b = true;
          }
          ...
          if (d == "separator") {
            ...
            if (!b) {
              if (s[0].className.indexOf("jqx-grid-menu-item-touch") >= 0) {
                s[0].className = this.toThemeProperty(
    ...
    destroy: function () {
      ...
      b.removeHandler(
        a(document),
        "mousedown.menu" + b.element.id,
        b._closeAfterClick
      );
      b.removeHandler(
        a(document),
        "mouseup.menu" + b.element.id,
        b._closeAfterClick
      );
      ...
      if (b.isTouchDevice()) {
        b.removeHandler(
          a(document),
          a.jqx.mobile.getTouchEventName("touchstart") + ".menu" + b.element.id,
          b._closeAfterClick,
          this
        );
      }
