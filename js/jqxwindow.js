  ...
  a.extend(a.jqx._jqxWindow.prototype, {
    ...
    createInstance: function () {
      ...
      if (this.restricter) {
        ...
        this.addHandler(
          a(window),
          "orientationchanged." + this.element.id,
          function () {
            h();
          }
        );
        this.addHandler(
          a(window),
          "orientationchange." + this.element.id,
          function () {
            h();
          }
        );
    ...
    _validateProperties: function () {
      try {
        ...
        if (
          isNaN(this.closeButtonSize) ||
          parseInt(this.closeButtonSize, 10) < 0
        ) {
          throw new Error(
            this._invalidArgumentExceptions.invalidCloseButtonSize
          );
        }
        if (
          isNaN(this.collapseButtonSize) ||
          parseInt(this.collapseButtonSize, 10) < 0
        ) {
          throw new Error(
            this._invalidArgumentExceptions.invalidCollapseButtonSize
          );
        }
      } catch (e) {
        throw new Error(e);
    ...
    _validateSize: function () {
      ...
      if (
        (this.dragArea &&
          ((this.dragArea.height !== null &&
            this.host.height() > this.dragArea.height) ||
            parseInt(this.height, 10) > this.dragArea.height)) ||
        (this.dragArea.width !== null && this.width > this.dragArea.width) ||
        this.maxHeight > this.dragArea.height ||
        this.maxWidth > this.dragArea.width
      ) {
      }
    },
    _validateSizeLimits: function () {
      ...
      if (this.minHeight && this.maxHeight) {
        if (
          parseInt(this.minHeight, 10) > parseInt(this.maxHeight, 10) &&
      ...
      if (this.minWidth && this.maxWidth) {
        if (
          parseInt(this.minWidth, 10) > parseInt(this.maxWidth, 10) &&
    ...
    _validateAnimationProperties: function () {
      if (
        ...
        this.animationType !== "combined" &&
        this.animationType !== "none"
      ) {
        throw new Error(this._invalidArgumentExceptions.invalidAnimationType);
      }
      if (
        isNaN(parseInt(this.closeAnimationDuration, 10)) ||
        this.closeAnimationDuration < 0
      ) {
        throw new Error(
          this._invalidArgumentExceptions.invalidCloseAnimationDuration
        );
      }
      if (
        isNaN(parseInt(this.showAnimationDuration, 10)) ||
        this.showAnimationDuration < 0
      ) {
        throw new Error(
          this._invalidArgumentExceptions.invalidShowAnimationDuration
        );
      }
    },
    _validateInteractionProperties: function () {
      if (
        parseInt(this.keyCode, 10) < 0 ||
        (parseInt(this.keyCode, 10) > 130 && this.keyCode !== "esc")
      ) {
        throw new Error(this._invalidArgumentExceptions.invalidKeyCode);
      }
      if (
        this.dragArea !== null &&
        (typeof this.dragArea.width === "undefined" ||
          typeof this.dragArea.height === "undefined" ||
          typeof this.dragArea.left === "undefined" ||
          typeof this.dragArea.top === "undefined")
      ) {
      ...
      if (
        ...
        this.closeButtonAction !== "close"
      ) {
        throw new Error(
          this._invalidArgumentExceptions.invalidCloseButtonAction
        );
      }
    },
    ...
    _addHeaderWrapper: function () {
      if (!this._headerContentWrapper) {
        this._header[0].innerHTML =
          '<div style="float:left;">' + this._header[0].innerHTML + "</div>";
    ...
    _addCloseButton: function () {
      if (!this._closeButton) {
        ...
        this._closeButtonWrapper.className = this.toThemeProperty(
          "jqx-window-close-button-background"
        );
        this._closeButton = document.createElement("div");
        this._closeButton.className = this.toThemeProperty(
    ...
    _addCollapseButton: function () {
      if (!this._collapseButton) {
        ...
        this._collapseButtonWrapper.className = this.toThemeProperty(
          "jqx-window-collapse-button-background"
        );
        this._collapseButton = document.createElement("div");
        this._collapseButton.className = this.toThemeProperty(
          "jqx-window-collapse-button jqx-icon-arrow-up"
        );
    ...
    _removeModal: function () {
      if (
        !this.isModal &&
        typeof this._modalBackground === "object" &&
    ...
    _makeModal: function () {
      if (this.isModal && !this._modalBackground) {
        ...
        this.addHandler(
          a(document),
          "keydown.window" + this.element.id,
          function (k) {
            if (k.keyCode !== 9) {
              return;
            }
    ...
    _performHeaderCollapseButtonLayout: function () {
      ...
      var e = this._toPx(
        this.showCloseButton ? this._closeButton.outerWidth(true) : 0
      );
      if (!this.rtl) {
      ...
      this._centerElement(
        ...
        a(this._collapseButton[0].parentElement),
        "y"
      );
    },
    ...
    _setChildrenLayout: function () {
      this._header.width(
        this.host.width() -
          (this._header.outerWidth(true) - this._header.width())
      );
      this._content.width(
        this.host.width() -
          (this._content.outerWidth(true) - this._content.width())
      );
      this._content.height(
        this.host.height() -
          this._header.outerHeight(true) -
          (this._content.outerHeight(true) - this._content.height())
      );
    },
    _validateMinSize: function () {
      ...
      var h = a(this._header.children()[0]).outerWidth(),
        e = this._header.children()[1]
          ? a(this._header.children()[1]).outerWidth()
          : 0,
        g = h + e;
    ...
    _removeEventHandlers: function () {
      ...
      this.removeHandler(
        a(document),
        this._getEvent("mousemove") + "." + this.host.attr("id")
      );
      this.removeHandler(
        a(document),
        this._getEvent("mouseup") + "." + this.host.attr("id")
      );
    ...
    _windowResizeHandler: function (h) {
      var e = h.data.self;
      e._header.width(
        e.host.width() - (e._header.outerWidth(true) - e._header.width())
      );
    ...
    _documentResizeHandlers: function () {
      ...
      if (this.isModal) {
        this.addHandler(
          a(window),
          "resize.window" + this.element.id,
          function () {
            if (
              typeof e._modalBackground === "object" &&
              e._modalBackground !== null
            ) {
              if (e.isOpen()) {
    ...
    _closeButtonHover: function () {
      ...
      this.addHandler(
        this._closeButton,
        this._getEvent("mouseenter"),
        function () {
          e._closeButton.addClass(
            e.toThemeProperty("jqx-window-close-button-hover")
          );
        }
      );
      this.addHandler(
    ...
    _collapseButtonHover: function () {
      ...
      this.addHandler(
        ...
        this._getEvent("mouseenter"),
        function () {
          e._collapseButton.addClass(
            e.toThemeProperty("jqx-window-collapse-button-hover")
          );
        }
      );
      this.addHandler(
    ...
    _setModalBackgroundStyles: function () {
      if (this.isModal) {
        ...
        if (!(a.jqx.browser.msie && a.jqx.browser.version < 9)) {
          ...
          this._modalBackground.style.filter =
            "alpha(opacity=" + this.modalOpacity * 100 + ")";
        }
    ...
    _addCloseHandlers: function () {
      ...
      if (this.keyboardCloseKey !== "none") {
        if (
          typeof this.keyboardCloseKey !== "number" &&
          this.keyboardCloseKey.toLowerCase() === "esc"
        ) {
      ...
      this.addHandler(
        ...
        function (f) {
          if (
            f.keyCode === e.keyboardCloseKey &&
            e.keyboardCloseKey != null &&
            e.keyboardCloseKey != "none"
          ) {
            e._closeWindow(f);
          } else {
            e._handleKeys(f);
    ...
    _headerMouseMoveHandler: function (f, i) {
      if (f._mouseDown && !f._isDragging) {
        ...
        g = e.top;
        if (
          h + 3 < f._mousePosition.x ||
          h - 3 > f._mousePosition.x ||
          g + 3 < f._mousePosition.y ||
          g - 3 > f._mousePosition.y
        ) {
          f._isDragging = true;
    ...
    _getDraggingArea: function () {
      ...
      e.width =
        this.dragArea && this.dragArea.width
          ? this.dragArea.width
          : this._getDocumentSize().width;
      e.height =
        this.dragArea && this.dragArea.height
          ? this.dragArea.height
          : this._getDocumentSize().height;
      return e;
    },
      ...
      while (e) {
        ...
        switch (this.position[e]) {
          ...
          case "left":
            ...
            break;
          case "bottom":
            this.element.style.top = this._toPx(
              f.height - this.host.height() + f.top
            );
            break;
          case "right":
            this.element.style.left = this._toPx(
              f.left + f.width - this.host.width()
            );
            break;
          default:
            if (!this.dragArea) {
    ...
    _toClose: function (f, e) {
      return (
        (f && e[0] === this.element) ||
        (e[0] !== this.element && typeof e[0] === "object")
      );
    },
        ...
        this.host.animate(
          { height: h },
          {
            ...
            complete: function () {
              ...
              e.collapsed = true;
              e._collapseButton.addClass(
                e.toThemeProperty("jqx-window-collapse-button-collapsed")
              );
              e._collapseButton.addClass(
                e.toThemeProperty("jqx-icon-arrow-down")
              );
    ...
    disable: function () {
      ...
      this._closeButton.addClass(
        this.toThemeProperty("jqx-window-close-button-disabled")
      );
      this._collapseButton.addClass(
        this.toThemeProperty("jqx-window-collapse-button-disabled")
      );
      this._content.addClass(
        this.toThemeProperty("jqx-window-content-disabled")
      );
    ...
    enable: function () {
      if (this.disabled) {
        ...
        this._header.removeClass(
          this.toThemeProperty("jqx-window-header-disabled")
        );
        this._content.removeClass(
          this.toThemeProperty("jqx-window-content-disabled")
        );
        this._closeButton.removeClass(
          this.toThemeProperty("jqx-window-close-button-disabled")
        );
        this._collapseButton.removeClass(
          this.toThemeProperty("jqx-window-collapse-button-disabled")
        );
    ...
    show: function (k, j) {
      ...
      switch (this.animationType) {
        ...
        case "combined":
          ...
          i._animationInProgress = true;
          this.host.animate(
            { opacity: 1, width: g + "px", height: e + "px" },
            {
              duration: j,
              complete: function () {
                i._animationInProgress = false;
    ...
    move: function (n, m, e, h) {
      ...
      if (a.jqx.browser.msie) {
        ...
        if (
          a(window).height() < a(document).height() &&
      ...
      if (
        parseInt(this.host.css("left"), 10) !== k.x ||
        parseInt(this.host.css("top"), 10) !== k.y
      ) {
        if (e) {
  ...
  var a = (function (c) {
    return {
      ...
      initResize: function (d) {
        ...
        this._getChildren(
          this.resizeTarget.maxWidth,
          this.resizeTarget.minWidth,
          this.resizeTarget.maxHeight,
      ...
      _validateResizeTargetDimensions: function () {
        ...
        this.resizeTarget.minWidth =
          3 * this.resizeIndicatorSize > this.minWidth
            ? 3 * this.resizeIndicatorSize
            : this.minWidth;
        this.resizeTarget.maxHeight = this.maxHeight;
        this.resizeTarget.minHeight =
          3 * this.resizeIndicatorSize > this.minHeight
            ? 3 * this.resizeIndicatorSize
            : this.minHeight;
      },
      ...
      _renderResize: function () {
        var d = this;
        if (
          d._resizeWrapper !== undefined &&
          c(d._resizeWrapper).parents().length > 0
        ) {
          return;
        }
      ...
      _resizeCaptureCursor: function (e, d) {
        if (
          ...
          if (this._isTouchDevice) {
            this._changeCursor(
              e - parseInt(this.resizeTarget.css("left"), 10),
              d - parseInt(this.resizeTarget.css("top"), 10)
            );
          ...
          if (
            e + f < this._mouseResizePosition.x ||
            e - f > this._mouseResizePosition.x ||
        ...
        if (e.enableResize && !e.collapsed) {
          if (!e.isResizing) {
            if (e._isTouchDevice) {
              var d = c.jqx.position(f);
              e._changeCursor(
                d.left - parseInt(e.resizeTarget.css("left"), 10),
                d.top - parseInt(e.resizeTarget.css("top"), 10)
              );
              return;
            }
            e._changeCursor(
              f.pageX - parseInt(e.resizeTarget.css("left"), 10),
              f.pageY - parseInt(e.resizeTarget.css("top"), 10)
            );
          }
        }
      },
      ...
      _validateResizeProperties: function () {
        try {
          ...
          if (
            this.resizeIndicatorSize < 0 ||
            isNaN(parseInt(this.resizeIndicatorSize, 10))
          ) {
      ...
      _changeCursor: function (d, e) {
        ...
        if (
          d <= this.resizeIndicatorSize &&
          d >= 0 &&
          e <= this.resizeIndicatorSize &&
          e > 0
        ) {
          ...
          if (
            e <= this.resizeIndicatorSize &&
            e > 0 &&
            d >= this.resizeTarget.width() - this.resizeIndicatorSize
          ) {
            this._resizeWrapper.style.cursor = "ne-resize";
            this._resizeDirection = "topright";
          } else {
            if (
              e >= this.resizeTarget.height() - this.resizeIndicatorSize &&
              e < this.resizeTarget.height() &&
              d <= this.resizeIndicatorSize &&
              d >= 0
            ) {
              ...
              if (
                ...
                if (d <= this.resizeIndicatorSize && d >= 0) {
                  ...
                  if (e <= this.resizeIndicatorSize && e > 0) {
                    ...
                    if (
                      e >=
                        this.resizeTarget.height() - this.resizeIndicatorSize &&
                      e < this.resizeTarget.height()
                    ) {
                      this._resizeWrapper.style.cursor = "n-resize";
      ...
      _getParent: function () {
        if (
          ...
          this.resizeParent.height &&
          this.resizeParent.width &&
          this.resizeParent.top &&
          this.resizeParent.left
        ) {
      ...
      _validateHeight: function (e, h, g) {
        var i = 0,
          ...
          f = this._getParent();
        if (
          c(window).width() > c(document).width() &&
          c.jqx.browser.msie &&
          f.height === c(document).height()
        ) {
      ...
      _validateWidth: function (h, g, f) {
        var i = 0,
          ...
          e = this._getParent();
        if (
          c(window).height() < c(document).height() &&
          c.jqx.browser.msie &&
          document.documentElement.clientWidth >=
            document.documentElement.scrollWidth &&
          e.width === c(document).width()
        ) {
          i = this._SCROLL_WIDTH;
        }
      ...
      _setResizeChildrenSize: function (e, f) {
        ...
        while (h) {
          ...
          if (f === "width") {
            var g =
              this.resizeTargetChildren[h].lastWidth -
              (this.resizeTarget.lastWidth - e);
            if (g < this.resizeTarget.maxWidth && g > 0) {
              this.resizeTargetChildren[h].width(g);
            }
          } else {
            var d =
              this.resizeTargetChildren[h].lastHeight -
              (this.resizeTarget.lastHeight - e);
