...
(function (a) {
  ...
  a.extend(a.jqx._jqxCheckBox.prototype, {
    ...
    render: function () {
      ...
      this.box.addClass(
        this.toThemeProperty("jqx-checkbox-default") +
          " " +
      ...
      if (!this.disabledContainer) {
        ...
        this.addHandler(this.host, "focus", function (e) {
          if (!d.disabled && !d.locked) {
            ...
            if (
              !d.clickTime ||
              (d.clickTime && new Date() - d.clickTime > 300)
            ) {
    ...
    _setState: function (c, b) {
      if (this.checked != c) {
        this.checked = c;
        if (this.checked) {
          this.checkMark[0].className = this.toThemeProperty(
    ...
    indeterminate: function () {
      ...
      if (a.jqx.browser.msie || this.animationShowDelay == 0) {
        this.checkMark.addClass(
          this.toThemeProperty("jqx-checkbox-check-indeterminate")
        );
      } else {
        this.checkMark.addClass(
          this.toThemeProperty("jqx-checkbox-check-indeterminate")
    ...
    disable: function () {
      ...
      if (this.checked == true) {
        this.checkMark.addClass(
          this.toThemeProperty("jqx-checkbox-check-disabled")
        );
      } else {
        if (this.checked == null) {
          this.checkMark.addClass(
            this.toThemeProperty("jqx-checkbox-check-indeterminate-disabled")
          );
        }
      }
