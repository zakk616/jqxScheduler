...
(function (a) {
  ...
  a.extend(a.jqx._jqxDropDownList.prototype, {
    ...
    createInstance: function (b) {
      var d = this;
      if (d.isMaterialized()) {
        var f = window.getComputedStyle(this.element);
        var e = f.getPropertyValue("--jqx-dropdown-animation");
        var c = f.getPropertyValue("--jqx-list-item-height");
        if (e && this.animationType == "default") {
          this.animationType = e.trim();
        }
        if (c && this.itemHeight === -1) {
          this.itemHeight = parseInt(c);
        }
      }
      this.render();
    },
    render: function () {
      ...
      o.dropdownlistContent.addClass(
        o.toThemeProperty("jqx-dropdownlist-content jqx-disableselect")
      );
      if (o.rtl) {
        o.dropdownlistContent.addClass(
          o.toThemeProperty("jqx-rtl jqx-dropdownlist-content-rtl")
        );
      }
      ...
      var c =
        o.toThemeProperty("jqx-widget") +
        " " +
        o.toThemeProperty("jqx-dropdownlist-state-normal") +
        " " +
        o.toThemeProperty("jqx-rc-all") +
        " " +
        o.toThemeProperty("jqx-fill-state-normal");
      ...
      try {
        ...
        var l = a(
          "<div style='overflow: hidden; background-color: transparent; border: none; position: absolute;' id='listBox" +
            o.id +
            "'><div id='innerListBox" +
            o.id +
            "'></div></div>"
        ...
        l.hide();
        l.addClass(o.toThemeProperty("jqx-listbox-container"));
        ...
        o.addHandler(o.listBoxContainer, "bindingComplete", function (e) {
          ...
          if (
            o.selectedIndex != o.listBoxContainer.jqxListBox("selectedIndex")
          ) {
            o.listBox = a.data(o.listBoxContainer[0], "jqxListBox").instance;
            o.listBoxContainer.jqxListBox({ selectedIndex: o.selectedIndex });
        ...
        if (o.dropDownContainer === "element") {
          o.listBoxContainer.css({ position: "absolute", top: 0, left: 0 });
        } else {
        ...
        if (o.template) {
          o.listBoxContainer.addClass(
            o.toThemeProperty("jqx-" + o.template + "-item")
          );
        }
        o.listBox = a.data(o.listBoxContainer[0], "jqxListBox").instance;
      ...
      o.propertyChangeMap.disabled = function (e, w, v, x) {
        if (x) {
          ...
          e.dropdownlistContent.addClass(
            o.toThemeProperty("jqx-dropdownlist-content-disabled")
          );
        } else {
          e.host.removeClass(
            o.toThemeProperty("jqx-dropdownlist-state-disabled")
          );
          e.host.removeClass(o.toThemeProperty("jqx-fill-state-disabled"));
          e.dropdownlistContent.removeClass(
            o.toThemeProperty("jqx-dropdownlist-content-disabled")
          );
        }
    ...
    _setSize: function () {
      ...
      var f = function () {
        ...
        if (e.dropDownWidth == "auto") {
          ...
          e.listBoxContainer.jqxListBox({ width: i });
    ...
    _updateHandlers: function () {
      ...
      if (!this.touch) {
        ...
        this.addHandler(this.host, "mouseleave", function () {
          if (!c.disabled && c.enableHover && c.renderMode !== "simple") {
            c.host.removeClass(
              c.toThemeProperty("jqx-dropdownlist-state-hover")
            );
      ...
      if (this.host.parents()) {
        this.addHandler(
          this.host.parents(),
          "scroll.dropdownlist" + this.element.id,
          function (e) {
            var f = c.isOpened();
            if (f) {
              c.close();
      ...
      if (this.touch) {
        this.addHandler(
          ...
          { me: this, listbox: this.listBox, id: this.id }
        );
      } else {
        this.addHandler(
          a(document),
      ...
      if (this.listBox) {
        if (this.listBox.content) {
          this.addHandler(this.listBox.content, "click", function (e) {
            if (!c.disabled) {
              if (
                c.listBox.itemswrapper &&
                e.target === c.listBox.itemswrapper[0]
              ) {
                return true;
              }
    ...
    renderSelection: function () {
      ...
      if (r == null) {
        var j = a(
          '<span unselectable="on" style="color: inherit; border: none; background-color: transparent;"></span>'
        );
        ...
        if (
          this.isMaterialized() &&
          !this.element.getAttribute("default-placeholder") &&
          this.hint
        ) {
          j[0].innerHTML = "";
          if (this.label) {
        ...
        if (this.selectionRenderer) {
          a.jqx.utilities.html(
            this.dropdownlistContent,
            this.selectionRenderer(j, -1, "", "")
          );
      ...
      j.appendTo(a(document.body));
      j.addClass(
        this.toThemeProperty("jqx-widget jqx-listitem-state-normal jqx-item")
      );
      var p = false;
      try {
        if (
      ...
      if (this.selectionRenderer) {
        a.jqx.utilities.html(
          this.dropdownlistContent,
          this.selectionRenderer(j, r.index, r.label, r.value)
        );
        if (this.focusable && this.isOpened()) {
          this.focus();
        }
    ...
    testOffset: function (h, f, c) {
      ...
      f.top -= Math.min(
        f.top,
        f.top + j > e && e > j ? Math.abs(j + c + 22) : 0
      );
      return f;
    },
    open: function () {
    ...
    showListBox: function () {
      ...
      if (
        ...
        this.width != null &&
        this.width.indexOf &&
        (this.width.indexOf("%") != -1 || this.width.indexOf("auto") != -1)
      ) {
      ...
      if (
        this.dropDownWidth == "auto" &&
        this.host.css("border-left-width") === "0px"
      ) {
        var p = this.element.offsetWidth;
        this.listBoxContainer.jqxListBox({ width: p + 1 });
        this.container.width(parseInt(p) + 25);
      }
      var n = this;
      ...
      if (this.renderMode !== "simple") {
        this.host.addClass(
          this.toThemeProperty("jqx-dropdownlist-state-selected")
        );
        this.host.addClass(this.toThemeProperty("jqx-fill-state-pressed"));
        if (this.dropDownVerticalAlignment == "top") {
          this.arrow.addClass(
            this.toThemeProperty("jqx-icon-arrow-up-selected")
          );
        } else {
          this.arrow.addClass(
            this.toThemeProperty("jqx-icon-arrow-down-selected")
          );
        }
      }
      ...
      if (this.enableBrowserBoundsDetection) {
        var h = this.testOffset(
          g,
          { left: parseInt(this.container.css("left")), top: parseInt(l) },
          parseInt(this.host.outerHeight())
        );
      ...
      if (this.animationType == "none" || this.animationType === "transform") {
        ...
        if (this.animationType == "fade") {
          g.css("margin-top", 0);
          g.css("opacity", 0);
          g.animate({ opacity: 1 }, this.openDelay, function () {
            a.data(document.body, "openedJQXListBoxParent", n);
          ...
          g.animate({ "margin-top": 0 }, this.openDelay, function () {
            a.data(document.body, "openedJQXListBoxParent", n);
            a.data(document.body, "openedJQXListBox" + n.id, g);
            n.ishiding = false;
            n.isanimating = false;
      ...
      if (this.animationType == "none") {
        ...
        if (this.animationType === "transform") {
          ...
          if (!d.ishiding) {
            ...
            var e = -b;
            if (
              parseInt(this.container.coord().top) <
              parseInt(this.host.coord().top)
            ) {
              e = b;
            }
            if (this.animationType == "fade") {
    ...
    propertyChangedHandler: function (b, c, f, e) {
      ...
      if (c == "template") {
        ...
        b.listBoxContainer.addClass(
          b.toThemeProperty("jqx-" + b.template + "-item")
        );
      ...
      if (c == "autoItemsHeight") {
        b.listBoxContainer.jqxListBox({ autoItemsHeight: e });
      }
      if (c == "filterable") {
