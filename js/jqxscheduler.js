  ...
  a.extend(a.jqx._jqxScheduler.prototype, {
    ...
    createEditRecurrenceDialog: function () {
      ...
      this.addHandler(a(b), "open", function (f) {
        d._raiseEvent("editRecurrenceDialogOpen", {
          dialog: b,
          appointment: d.selectedJQXAppointment
            ? d.selectedJQXAppointment.boundAppointment
            : null,
        });
      });
    ...
    _builddataloadelement: function () {
      ...
      this.dataloadelement = a(
        '<div class="jqx-datatable-load" style="z-index: 99998; background-color:rgba(50,50,50,0.1); overflow: hidden; position: absolute;"></div>'
      );
      var c = a(
    ...
    _testmodules: function () {
      ...
      if (e != "") {
        throw new Error(
          "jqxScheduler: Missing references to the following module(s): " + e
        );
        this.host.remove();
        return true;
      }
    ...
    isTouchDevice: function () {
      ...
      if (b) {
        ...
        this.host
          .find("jqx-widget-content")
          .addClass(this.toThemeProperty("jqx-touch"));
        this.host
          .find("jqx-widget-header")
          .addClass(this.toThemeProperty("jqx-touch"));
    ...
    _updateScrollbars: function (r) {
      ...
      var q =
        parseInt(d.host.css("border-left-width")) +
    ...
    _measureElementWidth: function (d) {
      var c = a(
        "<span style='visibility: hidden; white-space: nowrap;'>" +
          d +
          "</span>"
      );
    ...
    _arrangeAutoHeight: function (d) {
      ...
      if (this.height === "auto" || this.height === null || this.autoheight) {
        ...
        f +=
          this.showLegend && this._resources.length > 0 ? this.legendHeight : 0;
    ...
    _arrange: function () {
      ...
      if (
        "hidden" != this.vScrollBar[0].style.visibility ||
      ...
      if (
        this.hScrollBar[0].style.top != p + q - m - b - n + "px" ||
      ...
      var o = function (x) {
        if (
          ...
          x.bottomRight[0].style.left =
            1 + parseInt(x.vScrollBar.css("left")) + "px";
      ...
      if (this.showLegend && this.legendPosition == "bottom") {
        this.legendbarbottom.css(
          "top",
          p - 1 + q - d - (this.pageable ? this.pagerHeight : 0)
        );
        if (this.rtl) {
      ...
      this.vScrollBar[0].style.zIndex =
        this.tableZIndex + this.headerZIndex + 10 + this.columns.records.length;
      this.hScrollBar[0].style.zIndex =
        this.tableZIndex + this.headerZIndex + 10 + this.columns.records.length;
    ...
    databind: function (b, g, f) {
      ...
      this.resourcesDataView =
        this.resourcesDataView ||
        new a.jqx.scheduler.dataView("resourcesDataView");
      ...
      var i = function () {
        if (c == e) {
          ...
          if (!h.initializedcall) {
            ...
            if (
              (h.width != null && h.width.toString().indexOf("%") != -1) ||
              (h.height != null && h.height.toString().indexOf("%") != -1)
            ) {
              h._updatesize(true);
            }
            if (h.ready) {
            ...
            if (h._gridRenderElement) {
              ...
              var n =
                String.fromCharCode(83, 69, 84).toLowerCase() +
                "-" +
                String.fromCharCode(84, 73, 77, 69, 79, 85, 84).toLowerCase();
              ...
              if (x) {
                ...
                for (var A = 0; A < t.length; A++) {
                  ...
                  if (w.indexOf(";") >= 0) {
                    ...
                    w = w.split(";")[0];
                    if (
                      q.toLowerCase().indexOf("display") >= 0 &&
                      q.toLowerCase().indexOf("none")
                    ) {
                      n.hidden = true;
                    }
                  }
    ...
    ensureAppointmentVisible: function (b) {
      if (this.appointmentsByKey[b]) {
        return this._ensureAppointmentVisible(
          this.appointmentsByKey[b].jqxAppointment
        );
      }
      return false;
    },
      ...
      if (u <= w) {
        ...
        if (!this.rtl) {
          ...
          this.hScrollBar.jqxScrollBar(
            "setPosition",
            this.hScrollBar.jqxScrollBar("max") - u
          );
        }
      }
      if (u > F) {
    ...
    _ensureVisible: function (b) {
      ...
      if (o <= q) {
        ...
        if (!this.rtl) {
          ...
          this.hScrollBar.jqxScrollBar(
            "setPosition",
            this.hScrollBar.jqxScrollBar("max") - k
          );
        }
      }
      if (c >= A) {
        if (!this.rtl) {
          ...
          this.hScrollBar.jqxScrollBar(
            "setPosition",
            this.hScrollBar.jqxScrollBar("max") - (2 + h + c - p)
          );
        }
      }
      ...
      if (Math.round(z.position().top) === 0 || g === 0) {
        ...
        if (v[0] === z.parent()[0]) {
          return this.vScrollBar.jqxScrollBar(
            "setPosition",
            this.vScrollBar.jqxScrollBar("max")
          );
        }
      }
      if (f <= d) {
    ...
    render: function (i) {
      ...
      this.bottomRight = this.host
        ...
        .addClass(this.toTP("jqx-scrollbar-state-normal"));
      if (this.vScrollBar) {
      ...
      this.vScrollInstance = a.data(
        this.vScrollBar[0],
        "jqxScrollBar"
      ).instance;
      this.hScrollInstance = a.data(
        this.hScrollBar[0],
        "jqxScrollBar"
      ).instance;
      ...
      this.legendbarbottom.addClass(
        this.toTP("jqx-scheduler-legend-bar-bottom")
      );
    ...
    _render: function () {
      ...
      g.columnsheader =
        g.columnsheader || a('<div style="overflow: hidden;"></div>');
      ...
      g.schedulercontent =
        g.schedulercontent ||
        a(
          '<div style="width: 100%; overflow: hidden; position: absolute;"></div>'
        );
      ...
      var d = function (h, i) {
        ...
        a.each(g._resources, function (n) {
          ...
          var m = this.toString();
          var o = a(
            "<div data-toggle='on' style='border-color: " +
              l.border +
              "; background: " +
              l.background +
              ";' class='" +
              g.toThemeProperty("jqx-scheduler-legend") +
              "'></div>"
          );
          o.appendTo(h);
          var k = a(
            "<div class='" +
              g.toThemeProperty("jqx-scheduler-legend-label") +
              "'>" +
              m +
              "</div>"
          );
      ...
      for (var c = 0; c < 4; c++) {
        if (d.parentNode) {
          if (
            ...
            d.className.indexOf("jqx-scheduler-appointment-innter-content") ==
              -1 &&
            d.className.indexOf("jqx-scheduler-appointment-content") == -1 &&
            d.className.indexOf("jqx-scheduler-appointment-resize-indicator") ==
              -1
          ) {
            b = d;
          }
    ...
    _renderToolBar: function () {
      ...
      b.css("top", k);
      i.toolbarLeftButton = a(
        '<div type="button" style="outline: none; padding: 0px; display: flex; justify-content: center; align-items: center; margin-left: 3px; margin-right: 3px; height: 24px; width: 27px; float: left;"></div>'
      );
      i.toolbarRightButton = a(
        '<div type="button" style="outline: none; padding: 0px; display: flex; justify-content: center; align-items: center; margin-right: 3px; width: 27px; height: 24px; float: left;"></div>'
      );
      i.toolbarLeftButton.attr(
        "title",
        i.schedulerLocalization.toolBarPreviousButtonString
      );
      i.toolbarRightButton.attr(
        "title",
      ...
      i.dateTimeInput = a(
        '<div style="outline: none; padding: 0px; margin-top: 0px; margin-right: 3px; width: 27px; float: left;"></div>'
      );
      i.toolbarLeftButton.find(".jqx-icon-arrow-left").remove();
      i.toolbarRightButton.find(".jqx-icon-arrow-right").remove();
      var e = a(
        "<div style='outline: none;  width: 15px; height: 15px;'></div>"
      );
      ...
      i.addHandler(
        a(document),
        "mouseup.pagerbuttons" + i.element.id,
        function () {
          j.removeClass(i.toThemeProperty("jqx-icon-arrow-right-selected"));
          e.removeClass(i.toThemeProperty("jqx-icon-arrow-left-selected"));
        }
      ...
      i.toolbarViews = a(
        '<div style="margin-right: 10px; margin-top:0px; float: right;"></div>'
      );
      if (i.rtl) {
      ...
      a.each(i._views, function (p) {
        ...
        var m = a(o);
        m.addClass(
          i.toTP("jqx-group-button-normal jqx-button jqx-fill-state-normal")
        );
        h.push(m);
        if (n == 0) {
          if (!i.rtl) {
      ...
      var d = function (m) {
        var o = a.jqx.formatDate(
          i.getViewStart().toDate(),
          m,
          i.schedulerLocalization
        );
        var n = a.jqx.formatDate(
          i.getViewEnd().toDate(),
          m,
          i.schedulerLocalization
        );
    ...
    _setView: function (g) {
      ...
      f.toolbarViews
        ...
        .removeClass(f.toTP("jqx-fill-state-pressed"));
      if (!f.rtl) {
        a(f.toolbarViews.children()[g]).addClass(
          f.toTP("jqx-fill-state-pressed")
        );
      } else {
        a(f.toolbarViews.children()[f._views.length - 1 - g]).addClass(
          f.toTP("jqx-fill-state-pressed")
        );
      }
      if (f._view === g) {
    ...
    wheel: function (d, c) {
      if (
        ...
        c.editRecurrenceDialog.jqxWindow("isOpen")
      ) {
        return true;
      }
        ...
        if (this.hScrollBar.css("visibility") != "hidden") {
          ...
          if (d > 0) {
            if (this.hScrollInstance.value > 2 * 10) {
              this.hScrollInstance.setPosition(
                this.hScrollInstance.value - 2 * 10
              );
            } else {
            ...
            if (window.top != null && window.top != window.self) {
              ...
              if (g && g.indexOf(document.location.host) != -1) {
                e.removeHandler(
                  ...
                  "mouseup.jqxscheduler" + e.element.id
                );
              }
            }
          }
    ...
    _selectAppointment: function (d, i, f) {
      ...
      if (c.length > 0) {
        ...
        switch (b) {
          case "dayView":
            a(c)
              .find(".jqx-scheduler-appointment-left-resize-indicator")
              .hide();
            a(c)
              .find(".jqx-scheduler-appointment-right-resize-indicator")
              .hide();
            break;
          case "weekView":
            break;
        ...
        if (b.getAttribute("data-end-date") == null) {
          ...
          a.each(o[0].cells, function () {
            ...
            if (i === A) {
              b = this;
              r =
                q.getAttribute("data-end-date") != null &&
                b.getAttribute("data-end-date") != null;
    ...
    _removeFeedbackAndStopResize: function () {
      ...
      if (d.selectedJQXAppointment) {
        ...
        b.removeClass(
          d.toTP("jqx-scheduler-feedback-appointment jqx-disableselect")
        );
      }
        ...
        if (e === true) {
          if (b.isException()) {
            ...
            for (var h = 0; h < d.length; h++) {
              if (d[h].occurrenceFrom.equals(b.occurrenceFrom)) {
                for (
                  var g = 0;
                  g < b.rootAppointment.recurrenceException.length;
                  g++
                ) {
                  if (
                    b.rootAppointment.recurrenceException[g].equals(
                      d[h].occurrenceFrom
                    )
                  ) {
                    var q = b.from;
                    var f = new a.jqx.date(
                      d[h].occurrenceFrom.year(),
                      d[h].occurrenceFrom.month(),
                      d[h].occurrenceFrom.day(),
                      b.from.hour(),
                      b.from.minute(),
                      b.from.second()
                    );
          ...
          if (b.rootAppointment != null) {
            b.rootAppointment.recurrencePattern =
              b.rootAppointment.recurrencePattern.createNewPattern();
    ...
    _handleMouseUp: function (k, i, g) {
      ...
      if (j) {
        ...
        h.removeClass(
          f.toTP("jqx-scheduler-feedback-appointment jqx-disableselect")
        );
      ...
      var e = function (t, q) {
        ...
        if (g) {
          ...
          if (f.rtl && c && D) {
            ...
            if (f.rtl && (x == "monthView" || x == "timelineMonthView")) {
              ...
              if (
                f.rtl &&
                (x == "timelineDayView" || x == "timelineWeekView")
              ) {
            ...
            if (!c && !D) {
              ...
              if (!c && D) {
                ...
                if (c && D && !f.rtl) {
                  ...
                  if (c && D && f.rtl) {
                    q.from = a.jqx.scheduler.utilities.getStartOfDay(
                      q.to.add(new a.jqx.timeSpan(-d))
                    );
                    if (
                      q.from.hour() == 0 &&
                      q.from.minute() == 0 &&
        ...
        if (
          f._views[f._view].type == "monthView" &&
          f._views[f._view].monthRowAutoHeight
        ) {
          f._renderrows();
        } else {
          if (
            (f._views[f._view].type == "weekView" ||
              f._views[f._view].type == "dayView") &&
            (q.allDay || c)
          ) {
            if (f.tableRows > 1) {
              f._renderrows();
              ...
              if (l != w) {
                ...
                f._updateScrollbars(
                  f._hostHeight ? f._hostHeight : f.host.height()
                );
              }
            }
          } else {
    ...
    _handleDayWeekViewResize: function (E, D, h, F, n) {
      ...
      if (!r && !h.getAttribute("data-end-date")) {
            ...
            if (D > C._lastResizeY + a(h).height() / 2) {
              ...
              if (e(v)) {
                ...
                C.resizeTo = new a.jqx.date(
                  j.getAttribute("data-date"),
                  C.timeZone
                ).addMinutes(C.getMinutesPerScale());
              }
            } else {
              if (D < C._lastResizeY - a(h).height() / 2) {
                var G =
        ...
        var A =
          B.appointmentsRenderMode && B.appointmentsRenderMode == "exactTime";
        if (n.allDay || !A) {
          if (C.leftResize) {
            if (!C._lastResizeX) {
            ...
            if (E > C._lastResizeX + a(h).width() / 2) {
              ...
              if (p(d)) {
                ...
                if (!C.rtl) {
                  C.resizeFrom = new a.jqx.date(
                    h.getAttribute("data-date"),
                    C.timeZone
                  ).addDays(1);
                } else {
                  C.resizeTo = a.jqx.scheduler.utilities
                    .getEndOfDay(
                      new a.jqx.date(h.getAttribute("data-date"), C.timeZone)
                    )
                    .addDays(-1);
                }
              }
              ...
              if (E < C._lastResizeX - a(h).width() / 2) {
                ...
                if (p(d)) {
                  ...
                  if (!C.rtl) {
                    ...
                    C.resizeTo = a.jqx.scheduler.utilities.getEndOfDay(
                      new a.jqx.date(h.getAttribute("data-date"), C.timeZone)
                    );
                  }
                }
          ...
          for (var L = 0; L < this._getColumnsLengthPerView(); L++) {
            ...
            if (C.leftResize) {
              if (!C.rtl) {
                ...
                if (
                  n.from.hour() != 0 ||
                  (n.from.hour() == 0 && n.from.minute() != 0)
                ) {
                  if (
                    k < C.selectedAppointmentTableBounds.left &&
          ...
          if (C.leftResize) {
            ...
            if (C.rightResize) {
              for (var L = 0; L < t.length; L++) {
                ...
                var g =
                  L < t.length - 1
                    ? E >= F - this.cellWidth / 3 && E <= N - this.cellWidth / 3
                    : E >= F - this.cellWidth / 3;
                if (g) {
      ...
      if (k.allDay) {
          ...
          if (t > p._lastResizeX + a(q).width() / 2) {
            ...
            if (D(v)) {
              ...
              if (!p.rtl) {
                ...
                p.resizeTo = a.jqx.scheduler.utilities.getEndOfDay(
                  new a.jqx.date(
                    E.getAttribute("data-date"),
                    p.timeZone
                  ).addDays(-1)
            ...
            if (t < p._lastResizeX - a(q).width() / 2) {
              ...
              if (D(v)) {
                ...
                if (!p.rtl) {
                  ...
                  p.resizeTo = a.jqx.scheduler.utilities.getEndOfDay(
                    new a.jqx.date(E.getAttribute("data-date"), p.timeZone)
                  );
                }
              }
            }
        ...
        for (var J = 0; J < this._getColumnsLengthPerView(); J++) {
          ...
          if (p.leftResize) {
            ...
            if (
              k.from.hour() != 0 ||
              (k.from.hour() == 0 && k.from.minute() != 0)
            ) {
              if (
                j < p.selectedAppointmentTableBounds.left &&
        ...
        if (p.leftResize) {
          ...
          if (p.rightResize) {
            for (var J = 0; J < o.length; J++) {
              ...
              var I =
                J < o.length - 1
                  ? d >= c - this.cellWidth / 3 && d <= H - this.cellWidth / 3
                  : d >= c - this.cellWidth / 3;
              if (I) {
    ...
    _handleMonthViewResize: function (K, I, g, L, r) {
      ...
      for (var R = 0; R < 6; R++) {
        ...
        if (H.tableRows > 1) {
          H.feedbacks[R][0].style.top =
            parseInt(H.rows[6 * k + R].top) + E + "px";
        }
        a(H.feedbacks[R][0])
          .find(".jqx-scheduler-appointment-resize-indicator")
      ...
      if (!H.rtl) {
        if (H.leftResize) {
          ...
          for (var R = 0; R < 6; R++) {
            ...
            if (A == n) {
              ...
              if (t == n) {
                ...
                if (
                  G.appointmentsRenderMode == "exactTime" &&
              ...
              for (var Q = 0; Q < l.length; Q++) {
                ...
                if (t > N || (t == N && S > h)) {
                  ...
                  if (t == N && S <= h) {
                    if (n != N) {
                      C[0].style.width =
                        l[Q].width - L.left + parseInt(e) + "px";
                    }
                  }
                }
              }
          ...
          if (H.rightResize) {
            ...
            var D = a.jqx.scheduler.utilities.getEndOfDay(
              new a.jqx.date(g.getAttribute("data-date"), H.timeZone)
            );
    ...
    _addHandlers: function () {
      ...
      this.addHandler(
        a(document),
        "keydown.scheduler" + i.element.id,
        function (m) {
          g = false;
      ...
      this.addHandler(this.host, "focus", function (n) {
        if (i.focusedCell && !i.selectedAppointment && !g) {
          a(i.focusedCell).addClass(
            i.toThemeProperty("jqx-scheduler-cell-focus")
          );
        }
        i.focused = true;
        if (g) {
      ...
      this.addHandler(a(document), h, function (X) {
        ...
        if (
          i.hScrollInstance.isScrolling() ||
          i.vScrollInstance.isScrolling()
        ) {
          return true;
        }
        if (i._hostWidth) {
        ...
        if (i.mouseDownPosition) {
          if (
            (Math.abs(i.mouseDownPosition.left - M) >= 3 &&
              Math.abs(i.mouseDownPosition.left - M) <= 10) ||
            (Math.abs(i.mouseDownPosition.top - L) >= 3 &&
              Math.abs(i.mouseDownPosition.top - L) <= 10)
          ) {
            i.dragOrResize = true;
          }
        }
        if (i.selectedAppointment && i.dragOrResize) {
          ...
          if (!i.feedback) {
            ...
            var V = !(
              i.selectedAppointment[0].style.cursor == "row-resize" ||
              i.selectedAppointment[0].style.cursor == "col-resize" ||
              i.resizing
            );
            var p = function (x) {
              if (V) {
              ...
              T.addClass(
                i.toTP("jqx-scheduler-feedback-appointment jqx-disableselect")
              );
          ...
          if (
            ...
            switch (o) {
              ...
              case "weekView":
                ...
                if (!A) {
                  if (
                    L >= i.selectedAppointmentBounds.top - 15 &&
                    L <= i.selectedAppointmentBounds.top + 15
                  ) {
                    Q = true;
                    i.topResize = true;
                  ...
                  if (
                    L >=
                      i.selectedAppointmentBounds.top -
                        15 +
                        i.selectedAppointmentBounds.height &&
                    L <=
                      i.selectedAppointmentBounds.top +
                        i.selectedAppointmentBounds.height +
                        15
                  ...
                  if (
                    M >= i.selectedAppointmentBounds.left - 15 &&
                    M <= i.selectedAppointmentBounds.left + 15
                  ) {
                    Q = true;
                    i.leftResize = true;
                  ...
                  if (
                    M >=
                      i.selectedAppointmentBounds.left +
                        i.selectedAppointmentBounds.width -
                        15 &&
                    M <=
                      i.selectedAppointmentBounds.left +
                        i.selectedAppointmentBounds.width +
          ...
          if (
            ...
            if (
              q.getAttribute("data-view") != r + 1 &&
              i._resources.length > 0
            ) {
            ...
            if (
              (!U && i.selectedAppointment[0].style.cursor == "row-resize") ||
              i.selectedAppointment[0].style.cursor == "col-resize" ||
              i.resizing
            ) {
              if (
              ...
              var P =
                i.vScrollBar[0].style.visibility == "hidden"
                  ? 0
                  : 6 + i.vScrollBar.outerWidth();
              i._dragCell = q;
              ...
              if (o === "dayView" || o === "weekView") {
                ...
                if (o === "monthView") {
                  ...
                  if (G > N.top && G < N.top + q.offsetHeight) {
                    ...
                    i.feedback.css(
                      "top",
                      i.selectedAppointment.height() + N.top - 2
                    );
                  }
                  if (i.isTouchDevice()) {
          ...
          if (document.referrer != "" || window.frameElement) {
            if (window.top != null && window.top != window.self) {
              ...
              if (b && b.indexOf(document.location.host) != -1) {
                ...
                i.addHandler(
                  a(window.top.document),
                  "mouseup.jqxscheduler" + i.element.id,
                  f
                );
              }
            }
      ...
      this.addHandler(this.host, h, function (o) {
        ...
        if (
          ...
          o.target.className.indexOf(
            "jqx-scheduler-appointment-inner-content"
          ) == -1 &&
          o.target.className.indexOf("jqx-scheduler-appointment-content") ==
            -1 &&
          o.target.className.indexOf(
        ...
        for (var v = 0; v < 4; v++) {
          if (u.parentNode) {
            if (
              ...
              u.className.indexOf("jqx-scheduler-appointment-innter-content") ==
                -1 &&
        ...
        if (i.isMouseDown) {
          if (
            Math.abs(i.mousecaptureposition.left - C) > 3 ||
            Math.abs(i.mousecaptureposition.top - A) > 3
          ) {
      ...
      this.addHandler(
        a(document),
        "keydown.jqxscheduler" + i.element.id,
        function (m) {
      ...
      var j = function (K) {
        ...
        if (
          K.target.nodeName.toLowerCase() === "span" &&
          (K.target.className.indexOf("jqx-icon-arrow-down") >= 0 ||
            K.target.className.indexOf("jqx-icon-close") >= 0)
        ) {
        ...
        var q =
          ...
          K.target.className.indexOf(
            "jqx-scheduler-appointment-duration-status"
          ) == -1 &&
          K.target.className.indexOf(
            "jqx-scheduler-appointment-inner-content"
          ) == -1 &&
          K.target.className.indexOf("jqx-scheduler-appointment-status") ==
            -1 &&
          K.target.className.indexOf(
            "jqx-scheduler-appointment-resize-indicator"
          ) == -1 &&
        ...
        if (q && q[0].className.indexOf("feedback") == -1) {
          ...
          if (
            s - i.clickTime.getTime() < F &&
            i._lastSelectedAppointment &&
            p.id == i._lastSelectedAppointment.id &&
            K.which != 3
          ) {
            if (
              !p.readOnly &&
              !i.editRecurrenceDialog.jqxWindow("isOpen") &&
              (!i._editDialog ||
                (i._editDialog && !i._editDialog.jqxWindow("isOpen")))
            ) {
        ...
        if (i.view == "agendaView") {
          var q =
            K.target.className.indexOf("jqx-scheduler-agenda-appointment") !=
            -1;
          var L = false;
          if (!q && K.target && K.target.parentNode) {
            q =
              K.target.parentNode.className.indexOf(
        ...
        if (Q !== undefined && K.which != 3) {
          ...
          if (o) {
            ...
            if (
              i._lastSelectedCell &&
              i._lastSelectedCell.getAttribute("data-selected") == "true" &&
              u.getAttribute("data-selected") === "true" &&
              s - i.clickTime.getTime() < F
            ) {
              var M = new a.jqx.date(u.getAttribute("data-date"), i.timeZone);
          ...
          if (
            ...
            if (K.shiftKey && i._lastSelectedCell && D != "agendaView") {
              ...
              if (
                u.getAttribute("data-view") ===
                i.shiftSelectedCell.getAttribute("data-view")
              ) {
                I();
              }
    ...
    _deleteAppointment: function (b) {
      ...
      if (b.rootAppointment) {
        if (!b.isException()) {
          if (b.rootAppointment != null) {
            ...
            b.rootAppointment.recurrenceException.push(
              g.editAppointment.occurrenceFrom
            );
          } else {
          ...
          g._raiseEvent("appointmentDelete", {
            appointment: g.editAppointment.boundAppointment,
          });
        } else {
          var f = b.rootAppointment
            ? b.rootAppointment.exceptions
            : b.exceptions;
      ...
      for (var e = 0; e < g.appointments.length; e++) {
        if (
          g.appointments[e] == b.boundAppointment ||
              ...
              if (q) {
                ...
                for (var s = 0; s < l.length; s++) {
                  ...
                  if (p.indexOf(";") >= 0) {
                    ...
                    p = p.split(";")[0];
                    if (
                      h.toLowerCase().indexOf("display") >= 0 &&
                      h.toLowerCase().indexOf("none")
                    ) {
                      d.hidden = true;
                    }
                  }
        ...
        for (var d = b; d < k.length - c; d++) {
          ...
          if (h.getAttribute("data-selected") == "true") {
            ...
            g = g +=
              " " +
              f.toTP(
                "jqx-fill-state-pressed jqx-grid-cell-selected jqx-scheduler-cell-selected"
              );
    ...
    _rendercelltexts: function () {
      if (a.jqx.credits !== "44CE8878-FCD1-4EC7-9249-BA0F153A5DE8") {
    ...
    _handleKey: function (s) {
      ...
      var r = function (z) {
        ...
        var L =
          y.elements[y.elements.length - 1].cells[
            y.elements[y.elements.length - 1].cells.length - 1
          ].cell;
        var E =
          i.rows[i.rows.length - 1].cells[
            i.rows[i.rows.length - 1].cells.length - 1
          ];
        ...
        if (t) {
          ...
          if (H === "dayView" || H === "weekView") {
            ...
            if (H.indexOf("month") >= 0) {
              ...
              if (
                (!i.rtl && z == "left" && y.elements[0].cells.length > 1) ||
        ...
        if (i.selectedAppointment) {
          i.selectedAppointment.removeClass(
            i.toTP("jqx-scheduler-selected-appointment")
          );
          var O = i.selectedAppointment.attr("data-key");
          a('[data-key="' + O + '"]').addClass(
            i.toTP("jqx-scheduler-selected-appointment")
          );
          i.clearSelection();
        }
        ...
        var H = function (U, N, P) {
          if (
            ...
            if (!i.shiftSelectedCell) {
              ...
              if (
                U.getAttribute("data-end-date") &&
                i.shiftSelectedCell.getAttribute("data-end-date")
              ) {
                i.focusedCell = U;
                i._selectRange(U, i.shiftSelectedCell);
              } else {
    ...
    getSelection: function () {
      ...
      if (
        e._views[e._view].type.toLowerCase().indexOf("day") >= 0 ||
        e._views[e._view].type.toLowerCase().indexOf("week") >= 0
      ) {
    ...
    _renderhorizontalscroll: function () {
      ...
      var q = k._getvirtualcolumnsindexes(
        d,
        k._hostWidth,
        0,
        k.columns.records.length,
        false
      );
      var l = q.start;
      var n = q.end;
    ...
    _renderagenda: function () {
      ...
      var af = a.jqx.scheduler.utilities.getEndOfDay(
        ab.getViewEnd().addDays(-1)
      );
          ...
          for (var aq = 0; aq < G; aq++) {
            ...
            if (ao == 1) {
              ...
              if (Q === "auto") {
                ...
                if (
                  (ay.hour() == 0 && ay.minute() == 0) ||
                  (ay.hour() == 12 && ay.minute() == 0)
                ) {
                  var I = "hh tt";
                } else {
                  var I = "hh:mm";
              ...
              if (u.allDay) {
                ...
                if (!ab.rtl) {
                  an =
                    ...
                    ar +
                    "'>" +
                    z.toString(ad, ab.schedulerLocalization) +
                    " - " +
                    ay.toString(I, ab.schedulerLocalization) +
                    "</span>";
                } else {
                  an =
                    "<span class='" +
              ...
              if (ao == 2) {
                if (u.resourceId) {
                  a.each(ab._resources, function (r, x) {
                    if (u.resourceId == x) {
                      ...
                      var j = this.toString();
                      var w = ab.toTP(
                        "jqx-scheduler-agenda-appointment-resource jqx-scheduler-legend"
                      );
                      if (ab.rtl) {
                        var w = ab.toTP(
                          "jqx-scheduler-agenda-appointment-resource-rtl jqx-scheduler-legend"
                        );
                      }
                      var t =
                        "<div data-key='" +
                ...
                var y = u.description;
                var T = u.status
                  ? ab.schedulerLocalization.editDialogStatuses[u.status]
                  : "";
                ...
                var ar = ab.toTP(
                  "jqx-scheduler-agenda-appointment jqx-scheduler-legend-label"
                );
                if (ab.rtl) {
                  var ar = ab.toTP(
                    "jqx-scheduler-agenda-appointment-rtl jqx-scheduler-legend-label"
                  );
                }
                an +=
                  "<span data-key='" +
      ...
      function p() {
        ...
        i.indexOf = function (j) {
          for (var r = 0; r < i.cells.length; r++) {
            if (
              i.cells[r].getAttribute("data-key") == j.getAttribute("data-key")
            ) {
              return r;
            }
          }
        ...
        for (var aq = 0; aq < ak.cells.length; aq++) {
          if (ak.cells.length < ab.columns.records.length && !S) {
            ...
            while (ac >= 0) {
              ...
              if (
                ab.table[0].rows[ac].cells.length == ab.columns.records.length
              ) {
                var P = aw.cells[0];
    ...
    _renderrows: function () {
      ...
      if (W) {
        for (var X = 0; X < b; X++) {
          ...
          var aJ = a(
            '<table><tr><td role="gridcell" style="max-width: ' +
              aK +
              "px; width:" +
              aK +
              'px;" class="' +
          ...
          for (var X = 0; X < b; X++) {
            ...
            if (!R.timeColumn && (aF === "dayView" || aF === "weekView")) {
              ...
              if (!R.timeColumn && aF === "monthView" && G.showWeekNumbers) {
                ...
                if (
                  (aF === "monthView" && !G.showWeekNumbers) ||
                  aF === "timelineMonthView"
                ) {
                  ax++;
                } else {
            ...
            if (
              V.date.month() != C.month() &&
              aF === "monthView" &&
              !G.showOtherMonthDays
            ) {
            }
            if (
              V.resources &&
                ...
                if (aF.indexOf("month") == -1) {
                  if (!R.timeColumn) {
                    if (G.showWorkTime !== false) {
                      ...
                      var l = 18;
                      if (G.workTime) {
                        var O = G.workTime.fromDayOfWeek
                          ? G.workTime.fromDayOfWeek
                          : 0;
                        var J = G.workTime.toDayOfWeek
                          ? G.workTime.toDayOfWeek
                          : 0;
                        var ay =
                          G.workTime.fromHour !== undefined
                            ? G.workTime.fromHour
                            : 8;
            ...
            if (R.timeColumn && !R.hidden && aF === "monthView") {
              var a5 =
                V.toTP("jqx-scheduler-time-column") +
                " " +
                V.toTP("jqx-widget-header") +
                " " +
                V.toTP("jqx-cell") +
                " " +
                V.toTP("jqx-grid-cell") +
              ...
              if (C.minute() === 0) {
                var aJ =
                  '<td classname="jqx-disableselect" data-time-slot="true" data-date="' +
                  C.toString() +
            ...
            if (
              ...
              ah =
                "<span>" +
                a.jqx.dataFormat.formatdate(ah, "dd", V.schedulerLocalization) +
                "</span>";
            }
            var r = R.cellsFormat;
            if (R.timeColumn && !R.hidden) {
              ...
              if (a.jqx.dataFormat.isDate(ah)) {
                ah = a.jqx.dataFormat.formatdate(
                  ah,
                  r,
                  V.schedulerLocalization
                );
              ...
              if (Y < k) {
                if (!V.rtl) {
                  ...
                  a5 +=
                    " " + V.toTP("jqx-scheduler-time-column-header-cell-rtl");
                }
                ah = "";
              }
              if (Y < k) {
              ...
              if (r != "") {
                if (a.jqx.dataFormat) {
                  if (a.jqx.dataFormat.isDate(ah)) {
                    ...
                    if (
                      a.jqx.dataFormat.isNumber(ah) ||
                      (!isNaN(parseFloat(ah)) && isFinite(ah))
                    ) {
                      ah = a.jqx.dataFormat.formatnumber(
                        ah,
                        r,
                        V.schedulerLocalization
                      );
      ...
      function F() {
        ...
        c.indexOf = function (j) {
          for (var q = 0; q < c.cells.length; q++) {
            if (
              c.cells[q].getAttribute("data-key") == j.getAttribute("data-key")
            ) {
              return q;
            }
          }
      ...
      if (
        V.pinnedtable[0].style.display != "none" ||
        ((aF == "dayView" || aF == "weekView") && V.tableRows > 1)
      ) {
          ...
          for (var r = 0; r < u.length; r++) {
            ...
            if (
              ...
              if (
                ...
                h.selectedJQXAppointment.occurrenceFrom
                  .clearTime()
                  .equals(e.occurrenceFrom.clearTime())
              ) {
      ...
      for (var f = 0; f < this.appointmentsToRender.length; f++) {
        ...
        if ((!s.allDay && s.duration().days() < 1) || !D) {
          ...
          for (var W = 0; W < r.length; W++) {
            ...
            var q = new a.jqx.date(v[v.length - 1].date, M.timeZone).addMinutes(
              R
            );
            var ab = {
              cells: v,
              ...
              width: c,
              appointment: s,
              from: new a.jqx.date(v[0].date, M.timeZone),
              to: q,
            };
            B.push(ab);
            z.push(ab);
          ...
          if (s.rootAppointment) {
            s.rootAppointment.elements = s.rootAppointment.elements.concat(
              s.elements
            );
          }
        } else {
          ...
          for (var W = 0; W < r.length; W++) {
            ...
            var c =
              a(v[v.length - 1].cell).position().left + this.cellWidth - l.left;
            ...
            S = new a.jqx.date(
              a.jqx.scheduler.utilities.getEndOfDay(S),
              M.timeZone
            );
            var ab = {
              cells: v,
              x: O,
              y: N,
              height: d - N + this.cellHeight,
              width: c,
              appointment: s,
              from: a.jqx.scheduler.utilities.getStartOfDay(
                new a.jqx.date(v[0].date, M.timeZone)
              ),
              to: S,
            };
            B.push(ab);
    ...
    _renderAllDayAppointments: function (ar) {
      ...
      for (var ae = 0; ae < B.length; ae++) {
        ...
        if (z.appointment.from.hour() != 0 || z.appointment.to.hour() != 23) {
          ...
          if (!ac.rtl) {
            var K =
              parseFloat(ac.cellWidth / 24) * z.appointment.from.hour() +
            ...
            z.timex = K;
            var L =
              parseFloat(ac.cellWidth / 24) * z.appointment.to.hour() +
              parseFloat(ac.cellWidth / 48) * (z.appointment.to.minute() / 30);
      ...
      for (var ae = 0; ae < B.length; ae++) {
        ...
        if (R) {
          if (R == "transparent") {
            ...
            if (R == "tentative") {
              w = ac.toTP(
                "jqx-scheduler-appointment-status jqx-scheduler-appointment-status-stripes"
              );
              S =
        ...
        if (ac.rtl) {
          var w = ac.toTP(
            "jqx-scheduler-appointment-status-rtl jqx-scheduler-appointment-status"
          );
          S =
            "<div style='background: " +
            R +
          ...
          if (R == "tentative") {
            w = ac.toTP(
              "jqx-scheduler-appointment-status-rtl jqx-scheduler-appointment-status jqx-scheduler-appointment-status-stripes"
            );
            S =
              "<div style='background-color: " +
              X +
        ...
        if (ao === "") {
          if (k) {
            var ao =
              ...
              ac.toTP("jqx-scheduler-appointment-content") +
              "'>" +
              S +
              "<div class='" +
              ac.toTP("jqx-scheduler-appointment-inner-content") +
              "'>" +
              Q +
              "</div>" +
              G +
        ...
        if (r) {
          var h =
            M.toLowerCase() == "white"
              ? ac.toTP("jqx-icon-recurrence-exception-white")
              : ac.toTP("jqx-icon-recurrence-exception");
          N =
            "<div data-key='" +
            ak.appointment.id +
            "'" +
            ...
            "<div class='" +
            ac.toTP(
              "jqx-scheduler-appointment-resize-indicator jqx-scheduler-appointment-left-resize-indicator"
            ) +
            "'></div><div class='" +
            ac.toTP(
              "jqx-scheduler-appointment-resize-indicator jqx-scheduler-appointment-right-resize-indicator"
            ) +
            "'></div>";
        } else {
          if (b) {
            var q =
              M.toLowerCase() == "white"
                ? ac.toTP("jqx-icon-recurrence-white")
                : ac.toTP("jqx-icon-recurrence");
            N =
              "<div data-key='" +
              ak.appointment.id +
              "'" +
      ...
      for (var aa = 0; aa < B.length; aa++) {
        ...
        if (ak === "") {
          if (l) {
            var ak =
              "<div class='" +
              Z.toTP("jqx-scheduler-appointment-content") +
              "'>" +
              P +
              "<div class='" +
              Z.toTP("jqx-scheduler-appointment-inner-content") +
              "'>" +
              N +
              "</div>" +
              F +
        ...
        if (s) {
          var h =
            I.toLowerCase() == "white"
              ? Z.toTP("jqx-icon-recurrence-exception-white")
              : Z.toTP("jqx-icon-recurrence-exception");
          K =
            "<div data-key='" +
            ah.appointment.id +
            "'" +
            ...
            "<div class='" +
            Z.toTP(
              "jqx-scheduler-appointment-resize-indicator jqx-scheduler-appointment-top-resize-indicator"
            ) +
            "'></div><div class='" +
            Z.toTP(
              "jqx-scheduler-appointment-resize-indicator jqx-scheduler-appointment-bottom-resize-indicator"
            ) +
            "'></div></div>";
        } else {
          if (b) {
            var r =
              I.toLowerCase() == "white"
                ? Z.toTP("jqx-icon-recurrence-white")
    ...
    _renderTimelineAppointments: function (t, I) {
      ...
      for (var d = 0; d < this.appointmentsToRender.length; d++) {
        ...
        if (Q === "timelineMonthView") {
          var n = a.jqx.scheduler.utilities.getEndOfDay(
            new a.jqx.date(s[s.length - 1].date, E.timeZone)
          );
        }
        var R = {
          cellX: G,
        ...
        if (o.rootAppointment) {
          o.rootAppointment.elements = o.rootAppointment.elements.concat(
            o.elements
          );
        }
      }
      ...
      for (var ab = 0; ab < E.length; ab++) {
        ...
        if (e == "timelineMonthView" && Y.appointmentsRenderMode) {
          if (g.appointment.from.hour() != 0 || g.appointment.to.hour() != 23) {
            if (!Z.rtl) {
              var F =
                parseFloat(Z.cellWidth / 24) * g.appointment.from.hour() +
                parseFloat(Z.cellWidth / 48) *
                  (g.appointment.from.minute() / 30);
              var G =
                parseFloat(Z.cellWidth / 24) * g.appointment.to.hour() +
                parseFloat(Z.cellWidth / 48) * (g.appointment.to.minute() / 30);
              g.timewidth = g.width;
              g.timex = F;
              g.timewidth -= F;
              ...
              x[0].mousedown = function () {
                ...
                for (var aC = 0; aC < m[0].appointments.length; aC++) {
                  ...
                  aA.click(function (aI) {
                    var aJ = Z.getJQXAppointmentByElement(
                      Z.getAppointmentElement(aI.target)
                    );
                    Z._raiseEvent("appointmentClick", {
                      appointment: aJ.boundAppointment,
                    });
                  });
                  aA.dblclick(function (aJ) {
                    var aK = Z.getJQXAppointmentByElement(
                      Z.getAppointmentElement(aJ.target)
                    );
                    if (
                      !aK.readOnly &&
                      !Z.editRecurrenceDialog.jqxWindow("isOpen") &&
                      (!Z._editDialog ||
                        (Z._editDialog && !Z._editDialog.jqxWindow("isOpen")))
                    ) {
                    ...
                    Z._raiseEvent("appointmentDoubleClick", {
                      appointment: aK.boundAppointment,
                    });
                  });
                  aH += aA.outerHeight() + 4;
                  aF.append(aA);
      ...
      for (var e = 0; e < this.appointmentsToRender.length; e++) {
        ...
        for (var T = 0; T < s.length; T++) {
          ...
          if (L.showWeekNumbers) {
            var b =
              G - a(A[0].cell).position().left + M.columns.records[1].width;
          }
          var I = a(A[0].cell).position();
          var O = I.left;
          var N = I.top + R;
          var r = a.jqx.scheduler.utilities.getEndOfDay(
            new a.jqx.date(A[A.length - 1].date, M.timeZone)
          );
          var F = new a.jqx.date(A[0].date, M.timeZone);
          if (M.rtl) {
            var r = a.jqx.scheduler.utilities.getEndOfDay(
              new a.jqx.date(A[0].date, M.timeZone)
            );
            ...
            var b =
              G -
              a(A[A.length - 1].cell).position().left +
        ...
        if (t.rootAppointment) {
          t.rootAppointment.elements = t.rootAppointment.elements.concat(
            t.elements
          );
        }
      }
          ...
          if (X[T].length > 0) {
            ...
            for (var S = 0; S < 7; S++) {
              var aa = U.filter(function (j) {
                var i = a.jqx.scheduler.utilities.rangeIntersection(
                  j.from,
                  j.to,
                  f,
                  a.jqx.scheduler.utilities.getEndOfDay(f)
                );
                return i;
              });
              f = f.addDays(1);
    ...
    _getMonthAppointmentsPerWeek: function () {
      ...
      for (var e = 0; e < this.appointmentsToRender.length; e++) {
        ...
        for (var S = 0; S < r.length; S++) {
          ...
          var O = I.left;
          var N = I.top + Q;
          var q = a.jqx.scheduler.utilities.getEndOfDay(
            new a.jqx.date(A[A.length - 1].date, M.timeZone)
          );
          var F = new a.jqx.date(A[0].date, M.timeZone);
          if (M.rtl) {
    ...
    _renderUIMonthAppointments: function (ar) {
      ...
      for (var ae = 0; ae < I.length; ae++) {
        ...
        if (h.appointment.from.hour() != 0 || h.appointment.to.hour() != 23) {
          if (!ac.rtl) {
            var K =
              parseFloat(ac.cellWidth / 24) * h.appointment.from.hour() +
              parseFloat(ac.cellWidth / 48) *
                (h.appointment.from.minute() / 30);
            h.timewidth = h.width;
            if (
              h.from.clearTime().toString() ==
              h.appointment.from.clearTime().toString()
            ) {
              h.timex = K;
            } else {
              K = 0;
            ...
            var L =
              parseFloat(ac.cellWidth / 24) * h.appointment.to.hour() +
              parseFloat(ac.cellWidth / 48) * (h.appointment.to.minute() / 30);
            if (h.appointment.elements.length > 1) {
              if (
                h.appointment.elements[h.appointment.elements.length - 1] != h
              ) {
                L = 0;
              }
            }
            ...
            if (h.appointment.elements.length > 1) {
              if (h == h.appointment.elements[0]) {
                ...
                if (
                  h == h.appointment.elements[h.appointment.elements.length - 1]
                ) {
                  if (ab.appointmentsRenderMode == "exactTime") {
                    h.x += ac.cellWidth;
                    h.x -= K;
          ...
          if (al.y + al.height + 2 >= j.top + m.height()) {
            ...
            if (p[0]) {
              p[0].mousedown = function () {
                ...
                aB.find("span")
                  .removeClass()
                  .addClass(ac.toTP("jqx-icon-close"));
                ...
                for (var ax = 0; ax < m[0].appointments.length; ax++) {
                  ...
                  aA.click(function (aC) {
                    var aD = ac.getJQXAppointmentByElement(
                      ac.getAppointmentElement(aC.target)
                    );
                  ...
                  aA.dblclick(function (aD) {
                    var aE = ac.getJQXAppointmentByElement(
                      ac.getAppointmentElement(aD.target)
                    );
                    if (
                      !aE.readOnly &&
                      !ac.editRecurrenceDialog.jqxWindow("isOpen") &&
                      (!ac._editDialog ||
                        (ac._editDialog && !ac._editDialog.jqxWindow("isOpen")))
                    ) {
    ...
    getMaxAllDayAppointments: function (e) {
      ...
      if (
        this._resources.length < 2 ||
        !this.resources.orientation ||
      ...
      a.each(this.columns.records, function (l, m) {
        if (!this.hidden) {
          if (
            ...
            var m = 0;
            var n =
              h.vScrollBar[0].style.visibility == "hidden"
                ? 0
                : h.scrollBarSize + 5;
    ...
    _rendercolumnheaders: function () {
      ...
      a.each(this.columns.records, function (D, I) {
        ...
        var y =
          g.toTP("jqx-grid-column-header") + " " + g.toTP("jqx-widget-header");
        if (g.rtl) {
      ...
      for (var g = 0; g < this.columnGroupslevel - 1; g++) {
        for (var k = 0; k < this.columnGroups.length; k++) {
          ...
          if (o.groups) {
            ...
            var l = r--;
            var e = a(
              '<div role="columnheader" style="z-index: ' +
                l +
            ...
            if (d == "views") {
              ...
              if (d === "height") {
                ...
                if (d === "width") {
                  ...
                  if (d === "source") {
                    var e = b.vScrollBar.jqxScrollBar("value");
                    b.updateBoundData("dataBind", function () {
                      b.scrolltop(0);
                      b.vScrollBar.jqxScrollBar({ value: e });
                    });
                  } else {
                    if (d == "resources") {
                      var e = b.vScrollBar.jqxScrollBar("value");
                              ...
                              if (d == "showLegend") {
                                ...
                                if (d == "disabled") {
                                  ...
                                  b.host
                                    ...
                                    .css("cursor", e ? "default" : "pointer");
                                  b.host
                                    .find(".jqx-grid-group-expand")
                                    .css("cursor", e ? "default" : "pointer");
                                } else {
                                  if (d == "columnsHeight") {
                                    b._render();
                                    ...
                                    if (d == "localization") {
                                      b._render();
                                      if (b.editRecurrenceDialog) {
                                        b.editRecurrenceDialog.jqxWindow(
                                          "destroy"
                                        );
