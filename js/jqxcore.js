  ...
  (function (bd, G) {
    ...
    C.fn = C.prototype = {
      ...
      slice: function () {
        return this.pushStack(
          ...
          "slice",
          aD.call(arguments).join(",")
        );
      },
      map: function (bu) {
        return this.pushStack(
          C.map(this, function (bw, bv) {
    ...
    C.extend({
      ...
      isPlainObject: function (bw) {
        ...
        try {
          if (
            bw.constructor &&
            !b.call(bw, "constructor") &&
            !b.call(bw.constructor.prototype, "isPrototypeOf")
          ) {
            return false;
          }
        } catch (bv) {
      ...
      parseHTML: function (bx, bw, bu) {
        ...
        return C.merge(
          [],
          (bv.cacheable ? C.clone(bv.fragment) : bv.fragment).childNodes
        );
      },
      ...
      parseXML: function (bw) {
        ...
        if (
          !bu ||
          !bu.documentElement ||
          bu.getElementsByTagName("parsererror").length
        ) {
      ...
      map: function (bu, bB, bC) {
        var bz,
          ...
          bx =
            ...
            (bv !== G &&
              typeof bv === "number" &&
              ((bv > 0 && bu[0] && bu[bv - 1]) || bv === 0 || C.isArray(bu)));
        if (bx) {
          for (; bw < bv; bw++) {
            bz = bB(bu[bw], bw, bC);
            if (bz != null) {
            ...
            if (bA) {
              for (; bx < bv; bx++) {
                bA(
                  bu[bx],
                  bD,
                  bw ? bB.call(bu[bx], bx, bA(bu[bx], bD)) : bB,
                  bC
                );
              }
            }
    ...
    C.support = (function () {
      ...
      bG = {
        ...
        html5Clone:
          ak.createElement("nav").cloneNode(true).outerHTML !== "<:nav></:nav>",
      ...
      C(function () {
        ...
        if (bd.getComputedStyle) {
          ...
          bG.boxSizingReliable =
            (bd.getComputedStyle(bM, null) || { width: "4px" }).width === "4px";
          bL = ak.createElement("div");
          bL.style.cssText = bM.style.cssText = bJ;
          bL.style.marginRight = bL.style.width = "0";
          bM.style.width = "1px";
          bM.appendChild(bL);
          bG.reliableMarginRight = !parseFloat(
            (bd.getComputedStyle(bL, null) || {}).marginRight
          );
        }
    ...
    C.fn.extend({
      ...
      hasClass: function (bu) {
        ...
        for (; bw < bv; bw++) {
          if (
            this[bw].nodeType === 1 &&
            (" " + this[bw].className + " ").replace(aI, " ").indexOf(bx) >= 0
          ) {
            return true;
          }
        }
            ...
            for (; bv < bz; bv++) {
              ...
              if (
                ...
                (C.support.optDisabled
                  ? !bw.disabled
                  : bw.getAttribute("disabled") === null) &&
                (!bw.parentNode.disabled ||
                  !C.nodeName(bw.parentNode, "optgroup"))
              ) {
                bA = C(bw).val();
                if (bx) {
                  return bA;
      ...
      propHooks: {
        tabIndex: {
          get: function (bv) {
            ...
            return bu && bu.specified
              ? parseInt(bu.value, 10)
              : z.test(bv.nodeName) || (h.test(bv.nodeName) && bv.href)
              ? 0
              : G;
          },
        },
    ...
    var bf = /^(?:textarea|input|select)$/i,
      ...
      bs = function (bu) {
        return C.event.special.hover
          ? bu
          : bu.replace(F, "mouseenter$1 mouseleave$1");
      };
    C.event = {
        ...
        if (!bA) {
          bC.handle = bA = function (bK) {
            return typeof C !== "undefined" &&
              (!bK || C.event.triggered !== bK.type)
              ? C.event.dispatch.apply(bA.elem, arguments)
              : G;
          };
          bA.elem = bx;
        }
        ...
        for (bJ = 0; bJ < bC.length; bJ++) {
          ...
          for (bA = 0; bA < bu.length; bA++) {
            ...
            if (
              (bB || bw === bG.origType) &&
              (!bI || bI.guid === bG.guid) &&
              (!bv || bv.test(bG.namespace)) &&
              (!by || by === bG.selector || (by === "**" && bG.selector))
            ) {
              bu.splice(bA--, 1);
              if (bG.selector) {
                bu.delegateCount--;
      ...
      trigger: function (bv, bC, bA, bJ) {
        ...
        if (!bJ && !bv.isDefaultPrevented()) {
          if (
            (!bF._default ||
              bF._default.apply(bA.ownerDocument, bC) === false) &&
            !(bG === "click" && C.nodeName(bA, "a")) &&
            C.acceptData(bA)
          ) {
            if (
              by &&
      ...
      dispatch: function (bu) {
          ...
          for (bK = bu.target; bK != this; bK = bK.parentNode || this) {
            if (bK.disabled !== true || bu.type !== "click") {
              ...
              for (bB = 0; bB < bz; bB++) {
                ...
                bx = bI.selector;
                if (bD[bx] === G) {
                  bD[bx] = bI.needsContext
                    ? C(bx, this).index(bK) >= 0
                    : C.find(bx, this, null, [bK]).length;
                }
                if (bD[bx]) {
                  bC.push(bI);
                }
        ...
        for (bB = 0; bB < bH.length && !bu.isPropagationStopped(); bB++) {
          ...
          for (
            bA = 0;
            bA < bv.matches.length && !bu.isImmediatePropagationStopped();
            bA++
          ) {
            bI = bv.matches[bA];
            if (
              bw ||
              (!bu.namespace && !bI.namespace) ||
              (bu.namespace_re && bu.namespace_re.test(bI.namespace))
            ) {
              bu.data = bI.data;
              bu.handleObj = bI;
              bE = (
                (C.event.special[bI.origType] || {}).handle || bI.handler
              ).apply(bv.elem, bG);
              if (bE !== G) {
                bu.result = bE;
                if (bE === false) {
      ...
      mouseHooks: {
        ...
        filter: function (bx, bw) {
          ...
          if (bx.pageX == null && bw.clientX != null) {
            ...
            bx.pageX =
              bw.clientX +
              ((bz && bz.scrollLeft) || (bu && bu.scrollLeft) || 0) -
              ((bz && bz.clientLeft) || (bu && bu.clientLeft) || 0);
            bx.pageY =
              bw.clientY +
              ((bz && bz.scrollTop) || (bu && bu.scrollTop) || 0) -
              ((bz && bz.clientTop) || (bu && bu.clientTop) || 0);
          }
    ...
    C.removeEvent = ak.removeEventListener
      ? function (bv, bu, bw) {
    ...
    (function (cn, bM) {
      var cs,
        ...
        b7 = cf(function (cC) {
          ...
          return (
            cC.firstChild &&
            typeof cC.firstChild.getAttribute !== bZ &&
            cC.firstChild.getAttribute("href") === "#"
          );
        }),
        bV = cf(function (cD) {
        ...
        b6 = cf(function (cC) {
          ...
          if (
            !cC.getElementsByClassName ||
            !cC.getElementsByClassName("e").length
          ) {
            return false;
          }
        ...
        bu = cf(function (cD) {
          cD.id = cu + 0;
          cD.innerHTML =
            "<a name='" + cu + "'></a><div name='" + cu + "'></div>";
          bG.insertBefore(cD, bG.firstChild);
          var cC =
            bD.getElementsByName &&
            bD.getElementsByName(cu).length ===
              2 + bD.getElementsByName(cu + 0).length;
          ...
          if ((cI = cj.exec(cF))) {
            if ((cE = cI[1])) {
              if (cG === 9) {
                ...
                if (
                  cC.ownerDocument &&
                  (cD = cC.ownerDocument.getElementById(cE)) &&
                  b5(cC, cD) &&
                  cD.id === cE
                ) {
                  cH.push(cD);
      ...
      b5 = cl.contains = bG.contains
        ? function (cD, cC) {
            var cF = cD.nodeType === 9 ? cD.documentElement : cD,
              cE = cC && cC.parentNode;
            return (
              cD === cE ||
              !!(cE && cE.nodeType === 1 && cF.contains && cF.contains(cE))
            );
          }
        : bG.compareDocumentPosition
        ? function (cD, cC) {
      ...
      cg = cl.selectors = {
          ...
          ID: bF
            ...
            : function (cF, cE, cD) {
                if (typeof cE.getElementById !== bZ && !cD) {
                  ...
                  return cC
                    ? cC.id === cF ||
                      (typeof cC.getAttributeNode !== bZ &&
                        cC.getAttributeNode("id").value === cF)
                      ? [cC]
                      : bM
                    : [];
                }
            ...
            if (cD[3]) {
              ...
              if ((cE = cD[4])) {
                if (
                  ch.test(cE) &&
                  (cC = bw(cE, true)) &&
                  (cC = cE.indexOf(")", cE.length - cC) - cE.length)
                ) {
                  cE = cE.slice(0, cC);
        ...
        filter: {
          ...
          CLASS: function (cC) {
            ...
            return (
              cD ||
              ((cD = new RegExp("(^|" + b3 + ")" + cC + "(" + b3 + "|$)")) &&
                cp(cC, function (cE) {
                  return cD.test(
                    cE.className ||
                      (typeof cE.getAttribute !== bZ &&
          ...
          ATTR: function (cE, cD, cC) {
            return function (cH, cG) {
              ...
              return cD === "="
                ...
                ? cC && cF.indexOf(cC) > -1
                : cD === "$="
                ? cC && cF.substr(cF.length - cC.length) === cC
                : cD === "~="
                ? (" " + cF + " ").indexOf(cC) > -1
                : cD === "|="
                ? cF === cC || cF.substr(0, cC.length + 1) === cC + "-"
                : false;
            };
          },
          ...
          PSEUDO: function (cF, cE) {
            var cC,
              cD =
                cg.pseudos[cF] ||
                cg.setFilters[cF.toLowerCase()] ||
                cl.error("unsupported pseudo: " + cF);
            if (cD[cu]) {
              return cD(cE);
            }
            if (cD.length > 1) {
              cC = [cF, cF, "", cE];
              return cg.setFilters.hasOwnProperty(cF.toLowerCase())
                ? cw(function (cI, cK) {
                    var cH,
                      cG = cD(cI, cE),
                      cJ = cG.length;
        ...
        pseudos: {
          ...
          contains: cw(function (cC) {
            return function (cD) {
              return (
                (cD.textContent || cD.innerText || bv(cD)).indexOf(cC) > -1
              );
            };
          }),
          enabled: function (cC) {
          ...
          text: function (cE) {
            var cD, cC;
            return (
              cE.nodeName.toLowerCase() === "input" &&
              (cD = cE.type) === "text" &&
              ((cC = cE.getAttribute("type")) == null ||
                cC.toLowerCase() === cD)
            );
          },
          radio: cd("radio"),
          ...
          focus: function (cC) {
            ...
            return (
              cC === cD.activeElement &&
              (!cD.hasFocus || cD.hasFocus()) &&
              !!(cC.type || cC.href || ~cC.tabIndex)
            );
          },
          active: function (cC) {
      ...
      bL = bG.compareDocumentPosition
        ? function (cD, cC) {
            ...
            return (
              !cD.compareDocumentPosition || !cC.compareDocumentPosition
                ? cD.compareDocumentPosition
                : cD.compareDocumentPosition(cC) & 4
            )
              ? -1
              : 1;
          }
        ...
        var cD,
          ...
          cC = [
            function (cP, cO, cN) {
              return (
                (!cL && (cN || cO !== ce)) ||
                ((cD = cO).nodeType ? cJ(cP, cO, cN) : cK(cP, cO, cN))
              );
            },
          ];
        for (; cF < cH; cF++) {
              ...
              return cx(
                ...
                cF > 1 &&
                  cI
                    ...
                    .replace(co, "$1"),
                cG,
                cF < cE && b2(cI.slice(cF, cE)),
                cE < cH && b2((cI = cI.slice(cE))),
                cE < cH && cI.join("")
              );
            }
            cC.push(cG);
          ...
          if (cI.length === 1) {
            ...
            for (cH = cb.POS.test(cE) ? -1 : cN.length - 1; cH >= 0; cH--) {
              ...
              if ((cL = cg.find[cM])) {
                if (
                  (cK = cL(
                    cD.matches[0].replace(bY, ""),
                    (cm.test(cN[0].type) && cC.parentNode) || cC,
                    cJ
                  ))
                ) {
                  cN.splice(cH, 1);
      ...
      if (bD.querySelectorAll) {
        (function () {
          var cH,
            ...
            cF =
              bG.matchesSelector ||
              bG.mozMatchesSelector ||
              bG.webkitMatchesSelector ||
              bG.oMatchesSelector ||
              bG.msMatchesSelector;
          cf(function (cJ) {
              ...
              if (!bR(cK) && !cC.test(cM) && !cD.test(cM)) {
                try {
                  ...
                  if (
                    cJ ||
                    cH ||
                    (cK.document && cK.document.nodeType !== 11)
                  ) {
                    return cJ;
                  }
                } catch (cL) {}
    ...
    C.fn.extend({
      ...
      is: function (bu) {
        return (
          ...
          (typeof bu === "string"
            ? aQ.test(bu)
              ? C(bu, this.context).index(this[0]) >= 0
              : C.filter(bu, this).length > 0
            : this.filter(bu).length > 0)
        );
      },
      closest: function (by, bx) {
        var bz,
          ...
          bv = [],
          bA =
            aQ.test(by) || typeof by !== "string"
              ? C(by, bx || this.context)
              : 0;
        for (; bw < bu; bw++) {
          bz = this[bw];
      ...
      add: function (bu, bv) {
        var bx =
            typeof bu === "string"
              ? C(bu, bv)
              : C.makeArray(bu && bu.nodeType ? [bu] : bu),
          bw = C.merge(this.get(), bx);
        return this.pushStack(x(bx[0]) || x(bw[0]) ? bw : C.unique(bw));
      },
      addBack: function (bu) {
        return this.add(
          bu == null ? this.prevObject : this.prevObject.filter(bu)
        );
      },
    });
    ...
    C.each(
      {
        ...
        contents: function (bu) {
          return C.nodeName(bu, "iframe")
            ? bu.contentDocument || bu.contentWindow.document
            : C.merge([], bu.childNodes);
        },
      },
      function (bu, bv) {
    ...
    C.extend({
      filter: function (bw, bu, bv) {
        ...
        return bu.length === 1
          ? C.find.matchesSelector(bu[0], bw)
            ? [bu[0]]
            : []
          : C.find.matches(bw, bu);
      },
    ...
    C.fn.extend({
        ...
        return C.access(
          ...
          function (bv) {
            return bv === G
              ? C.text(this)
              : this.empty().append(
                  ((this[0] && this[0].ownerDocument) || ak).createTextNode(bv)
                );
          },
          null,
          bu,
        ...
        return C.access(
          ...
          function (by) {
            ...
            if (
              typeof by === "string" &&
              !W.test(by) &&
              (C.support.htmlSerialize || !ac.test(by)) &&
              (C.support.leadingWhitespace || !ah.test(by)) &&
              !am[(c.exec(by) || ["", ""])[1].toLowerCase()]
            ) {
              by = by.replace(L, "<$1></$2>");
              try {
                for (; bw < bv; bw++) {
      ...
      replaceWith: function (bu) {
        ...
        return this.length
          ? this.pushStack(C(C.isFunction(bu) ? bu() : bu), "replaceWith", bu)
          : this;
      },
      detach: function (bu) {
        ...
        if (this[0]) {
          ...
          if (by) {
            ...
            for (bC = bw.cacheable || bu - 1; bx < bu; bx++) {
              bD.call(
                bE && C.nodeName(this[bx], "table")
                  ? a3(this[bx], "tbody")
                  : this[bx],
                bx === bC ? bz : C.clone(bz, true, true)
              );
            }
          }
          bz = by = null;
          if (bv.length) {
            C.each(bv, function (bF, bG) {
              if (bG.src) {
                ...
                C.globalEval(
                  (bG.text || bG.textContent || bG.innerHTML || "").replace(
                    aG,
                    ""
                  )
                );
    ...
    function a3(bv, bu) {
      return (
        bv.getElementsByTagName(bu)[0] ||
        bv.appendChild(bv.ownerDocument.createElement(bu))
      );
    }
    function r(bB, bv) {
    ...
    C.buildFragment = function (bx, by, bv) {
      ...
      if (
        ...
        bA.charAt(0) === "<" &&
        !I.test(bA) &&
        (C.support.checkClone || !o.test(bA)) &&
        (C.support.html5Clone || !ac.test(bA))
      ) {
        bu = true;
        bw = C.fragments[bA];
        bz = bw !== G;
    ...
    C.each(
      ...
      function (bu, bv) {
        C.fn[bu] = function (bw) {
          ...
          if (
            (bB == null ||
              (bB && bB.nodeType === 11 && bB.childNodes.length === 1)) &&
            bx === 1
          ) {
            bC[bv](this[0]);
            return this;
            ...
            if (!P.test(bG)) {
              ...
              if (!C.support.tbody) {
                ...
                for (bD = bv.length - 1; bD >= 0; --bD) {
                  if (
                    C.nodeName(bv[bD], "tbody") &&
                    !bv[bD].childNodes.length
                  ) {
              ...
              if (!C.support.leadingWhitespace && ah.test(bG)) {
                bB.insertBefore(
                  bw.createTextNode(ah.exec(bG)[0]),
                  bB.firstChild
                );
              }
              bG = bB.childNodes;
        ...
        if (bu) {
          bJ = function (bM) {
            if (!bM.type || bp.test(bM.type)) {
              return bx
                ? bx.push(bM.parentNode ? bM.parentNode.removeChild(bM) : bM)
                : bu.appendChild(bM);
            }
          };
          for (bE = 0; (bG = bI[bE]) != null; bE++) {
    ...
    (function () {
      ...
      C.uaMatch = function (bx) {
        ...
        var bw =
          /(chrome)[ \/]([\w.]+)/.exec(bx) ||
          /(webkit)[ \/]([\w.]+)/.exec(bx) ||
          /(opera)(?:.*version|)[ \/]([\w.]+)/.exec(bx) ||
          /(msie) ([\w.]+)/.exec(bx) ||
          (bx.indexOf("compatible") < 0 &&
            /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(bx)) ||
          [];
    ...
    var Q,
      ...
      E = new RegExp("^([-+])=(" + aE + ")", "i"),
      J = { BODY: "block" },
      ba = { position: "absolute", visibility: "hidden", display: "block" },
      aL = { letterSpacing: 0, fontWeight: 400 },
    ...
    function ap(bv, bu) {
      bv = bu || bv;
      return (
        C.css(bv, "display") === "none" || !C.contains(bv.ownerDocument, bv)
      );
    }
    function bb(bz, bu) {
      var by,
    ...
    function aN(bw) {
      ...
      bu.remove();
      if (bv === "none" || bv === "") {
        bc = ak.body.appendChild(
          bc ||
            C.extend(ak.createElement("iframe"), {
              frameBorder: 0,
              width: 0,
              height: 0,
            })
          ...
          return aO(
            ...
            bw
              ? aZ(
                  ...
                  bu,
                  bw,
                  C.support.boxSizing && C.css(bx, "boxSizing") === "border-box"
                )
              : 0
          );
        },
    ...
    if (C.expr && C.expr.filters) {
      C.expr.filters.hidden = function (bu) {
        return (
          (bu.offsetWidth === 0 && bu.offsetHeight === 0) ||
          (!C.support.reliableHiddenOffsets &&
            ((bu.style && bu.style.display) || Q(bu, "display")) === "none")
        );
      };
        ...
        return this.map(function () {
          ...
          .filter(function () {
            return (
              this.name &&
              !this.disabled &&
              (this.checked || p.test(this.nodeName) || aU.test(this.type))
            );
          })
          .map(function (bu, bv) {
            var bw = C(this).val();
    ...
    function bj(bw, bA, bD) {
        ...
        bx = bC.promise({
          ...
          createTween: function (bI, bF, bH) {
            var bG = C.Tween(
              ...
              bI,
              bF,
              bx.opts.specialEasing[bI] || bx.opts.easing
            );
            bx.tweens.push(bG);
            return bG;
          },
      ...
      return bx
        .progress(bx.opts.progress)
        .done(bx.opts.done, bx.opts.complete)
        .fail(bx.opts.fail)
        .always(bx.opts.always);
    }
    function aW(bx, bz) {
      var bw, bv, bA, by, bu;
      for (bw in bx) {
    ...
    function bm(by, bE, bu) {
      ...
      if (by.nodeType === 1 && ("height" in bE || "width" in bE)) {
        ...
        if (
          C.css(by, "display") === "inline" &&
          C.css(by, "float") === "none"
        ) {
          if (
            !C.support.inlineBlockNeedsLayout ||
            aN(by.nodeName) === "inline"
          ) {
    ...
    u.prototype = {
      ...
      run: function (bw) {
        ...
        if (this.options.duration) {
          this.pos = bv = C.easing[this.easing](
            bw,
            this.options.duration * bw,
            0,
            1,
    ...
    u.propHooks = {
      _default: {
        get: function (bv) {
          var bu;
          if (
            bv.elem[bv.prop] != null &&
            (!bv.elem.style || bv.elem.style[bv.prop] == null)
          ) {
        ...
        set: function (bu) {
          if (C.fx.step[bu.prop]) {
            ...
            if (
              bu.elem.style &&
              (bu.elem.style[C.cssProps[bu.prop]] != null ||
                C.cssHooks[bu.prop])
            ) {
    ...
    C.each(["toggle", "show", "hide"], function (bv, bu) {
      ...
      C.fn[bu] = function (bx, bz, by) {
        return bx == null ||
          typeof bx === "boolean" ||
          (!bv && C.isFunction(bx) && C.isFunction(bz))
          ? bw.apply(this, arguments)
          : this.animate(aY(bu, true), bx, bz, by);
      };
    });
    C.fn.extend({
      fadeTo: function (bu, bx, bw, bv) {
        return this.filter(ap)
          .css("opacity", 0)
          .show()
          .end()
          .animate({ opacity: bx }, bu, bw, bv);
      },
      animate: function (bA, bx, bz, by) {
        ...
        return bw || bu.queue === false
          ? this.each(bv)
          : this.queue(bu.queue, bv);
      },
    ...
    C.speed = function (bw, bx, bv) {
      ...
      bu.duration = C.fx.off
        ? 0
        : typeof bu.duration === "number"
        ? bu.duration
        : bu.duration in C.fx.speeds
        ? C.fx.speeds[bu.duration]
      ...
      sizeStyleChanged: function (bx) {
        ...
        var bu = function (bz) {
          ...
          if (
            bz &&
            bz[0] &&
            bz[0].attributeName === "style" &&
            bz[0].type === "attributes"
          ) {
            if (
              bA.element.offsetWidth !== bA.offsetWidth ||
              bA.element.offsetHeight !== bA.offsetHeight
            ) {
        ...
        C.fn[bw] = function (bx) {
          return C.access(
            ...
            function (by, bB, bA) {
              ...
              if (bz) {
                bz.scrollTo(
                  !bu ? bA : C(bz).scrollLeft(),
                  bu ? bA : C(bz).scrollTop()
                );
              } else {
                by[bB] = bA;
              }
    ...
    function aC(bu) {
      return C.isWindow(bu)
        ? bu
        : bu.nodeType === 9
        ? bu.defaultView || bu.parentWindow
        : false;
    }
    C.each({ Height: "height", Width: "width" }, function (bu, bv) {
      C.each(
        { padding: "inner" + bu, content: bv, "": "outer" + bu },
        function (bw, bx) {
...
var jqxBaseFramework = (window.jqxBaseFramework =
...
(function (b) {
  ...
  b.jqx.hasFunction = function (f, e) {
    ...
    var g = typeof e == Array || e.length > 0 ? e[0] : e;
    var d =
      typeof e == Array || e.length > 1 ? Array.prototype.slice.call(e, 1) : {};
    while (f[g] == undefined && f.base != null) {
  ...
  b.jqx.setvalueraiseevent = function (d, e, f) {
    ...
    if (
      d.propertyChangeMap != undefined &&
      d.propertyChangeMap[e] != undefined
    ) {
  ...
  b.jqx.jqxWidgetProxy = function (h, d, c) {
    ...
    throw (
      "jqxCore: Invalid parameter '" + b.jqx.serialize(c) + "' does not exist."
    );
  };
    ...
    if (!window[h]) {
      ...
      a[h] = window[h] = function (e, s) {
        ...
        if (p.length === 0) {
          ...
          if (h === "jqxTabs") {
            p = b(
              "<div><ul><li>Tab 1</li><li>Tab 2</li></ul><div>Content 1</div><div>Content 2</div></div>"
            );
          }
          if (h === "jqxRibbon") {
            p = b(
              "<div><ul><li>Tab 1</li><li>Tab 2</li></ul><div><div>Content 1</div><div>Content 2</div></div></div>"
            );
          }
          if (h === "jqxDocking") {
            p = b(
              "<div><div><div><div>Title 1</div><div>Content 1</div></div></div></div>"
            );
          }
          if (h === "jqxWindow") {
      ...
      if (e.length == 0 || (e.length == 1 && typeof e[0] == "object")) {
        if (this.length == 0) {
          if (this.selector) {
            ...
            throw new Error(
              "Invalid Selector! Please, check whether the used ID or CSS Class name is correct."
            );
          }
        }
        return this.each(function () {
          ...
          case "mousewheel":
            if (b.jqx.browser.mozilla) {
              h[0].addEventListener(
                "DOMMouseScroll",
                f,
                b.jqx.isPassiveSupported() ? { passive: false } : false
              );
            } else {
              h[0].addEventListener(
                "mousewheel",
          ...
          if (b.jqx.isHidden(E)) {
            ...
            if (w === undefined || w !== true) {
              if (D) {
                ...
                if (l.watchedElementData) {
                  for (var z = 0; z < l.watchedElementData.length; z++) {
                    if (
                      l.watchedElementData[z].element == B.jqxWidget.element
                    ) {
                      l.watchedElementData[z].offsetWidth =
                        B.jqxWidget.element.offsetWidth;
                      l.watchedElementData[z].offsetHeight =
                        B.jqxWidget.element.offsetHeight;
                      break;
                    }
                  }
                }
              ...
              if (B.jqxWidget.element) {
                ...
                if (
                  y.indexOf("dropdownlist") >= 0 ||
                  y.indexOf("datetimeinput") >= 0 ||
                  y.indexOf("combobox") >= 0 ||
                  y.indexOf("menu") >= 0
                ) {
          ...
          var g = function (i) {
            if (l.watchedElementData.forEach) {
              l.watchedElementData.forEach(function (u) {
                if (
                  u.element.offsetWidth !== u.offsetWidth ||
                  u.element.offsetHeight !== u.offsetHeight
                ) {
      ...
      try {
        return b.access(
          ...
          function (s) {
            ...
            if (s === undefined) {
              return f.nodeType === 1
                ? f.innerHTML.replace(rinlinejQuery, "")
                : undefined;
            }
            ...
            if (
              typeof s === "string" &&
              !r.test(s) &&
              (b.support.htmlSerialize || !k.test(s)) &&
              (b.support.leadingWhitespace || !q.test(s)) &&
              !t[(p.exec(s) || ["", ""])[1].toLowerCase()]
            ) {
              s = s.replace(h, "<$1></$2>");
              try {
                for (; m < j; m++) {
    ...
    if (f == undefined) {
      b.each(d.aria, function (h, i) {
        ...
        if (k != undefined && !b.isFunction(k)) {
          ...
          try {
            !d.base
              ? d.host.attr(h, k.toString())
              : d.base.host.attr(h, k.toString());
          } catch (g) {}
        }
      });
    } else {
  ...
  b.extend(b.jqx.mobile, {
    ...
    isTouchDevice: function () {
      ...
      try {
        ...
        if (navigator.platform.toLowerCase().indexOf("win") != -1) {
          if (
            j.indexOf("Windows Phone") >= 0 ||
            j.indexOf("WPDesktop") >= 0 ||
            j.indexOf("IEMobile") >= 0 ||
            j.indexOf("ZuneWP7") >= 0
          ) {
            this.touchDevice = true;
            return true;
    ...
    isWindowsPhone: function () {
      var d = navigator.userAgent.toLowerCase();
      var c =
        d.indexOf("windows phone") != -1 ||
        d.indexOf("WPDesktop") != -1 ||
        d.indexOf("ZuneWP7") != -1 ||
        d.indexOf("msie 9") != -1 ||
        d.indexOf("msie 11") != -1 ||
        (d.indexOf("msie 10") != -1 && d.indexOf("touch") != -1);
      return c;
    },
    ...
    touchScroll: function (B, M, Z, H, x, n) {
      ...
      if (this.simulatetouches) {
        ...
        b(window).on != undefined
          ? b(document).on("mouseup.touchScroll", P)
          : b(document).bind("mouseup.touchScroll", P);
        if (window.frameElement) {
          if (window.top != null) {
            ...
            if (window.top.document) {
              b(window.top.document).on
                ? b(window.top.document).on("mouseup", L)
                : b(window.top.document).bind("mouseup", L);
            }
          }
        }
        ...
        b(document).on != undefined
          ? b(document).on("touchend", K)
          : b(document).bind("touchend", K);
      }
      if (p.on) {
      ...
      p.on
        ? p.on(D + " touchcancel.touchScroll", s)
        : p.bind(D + " touchcancel.touchScroll", s);
    },
  });
  ...
  b.extend(b.jqx.string, {
    ...
    containsIgnoreCase: function (c, d) {
      ...
      return (
        c.toString().toUpperCase().indexOf(d.toString().toUpperCase()) != -1
      );
    },
    equals: function (c, d) {
      if (c == null || d == null) {
...
(function (b) {
  ...
  b.fn.val = function (d) {
    if (typeof d == "undefined") {
      if (
        b(this).hasClass("jqx-widget") ||
        b(this).hasClass("jqx-input-group")
      ) {
        ...
        .on(
          ...
          b.proxy(function (c) {
            if (
              ...
              !this.$element.has(c.target).length
            ) {
