...
(function (a) {
  ...
  a.extend(a.jqx._jqxInput.prototype, {
    ...
    createInstance: function () {
      var b = this;
      if (
        b.host.css("display") === "none" ||
        document.body.contains(b.element) === false
      ) {
        ...
        if (this.element.nodeName.toLowerCase() === "textarea") {
          ...
          if (this.element.nodeName.toLowerCase() === "div") {
            ...
            if (b.length > 0) {
              ...
              g.input = b[0];
              this.host.data(h);
              g.baseElement.className +=
                " " +
                g.toThemeProperty("jqx-widget jqx-rc-all jqx-input-group");
    ...
    _refreshClasses: function (d) {
      var c = d ? "addClass" : "removeClass",
        ...
        e =
          "jqx-popup jqx-input-popup jqx-menu jqx-menu-vertical jqx-menu-dropdown jqx-widget jqx-widget-content";
      ...
      if (!this.baseHost) {
        ...
        if (e) {
          ...
          d.element.style.width =
            Math.max(0, d.baseElement.offsetWidth - c - 1) + "px";
        ...
        a.jqx.utilities.resize(d.baseHost, function () {
          if (
            ...
            d.element.style.width =
              d.baseElement.offsetWidth - d._addonsWidth - 1 + "px";
          } else {
        ...
        if (b.baseHost) {
          ...
          if (a.jqx.browser.msie && a.jqx.browser.version < 9) {
            b.element.style.width =
              b.baseElement.offsetWidth - b._addonsWidth - 1 + "px";
          }
        } else {
    ...
    val: function (b) {
      if (
        arguments.length === 0 ||
        (b != null && typeof b === "object" && !b.label && !b.value)
      ) {
        if (
          this.displayMember !== "" &&
          this.valueMember !== "" &&
      ...
      if (b && b.label) {
        this.selectedItem = { label: b.label, value: b.value };
      ...
      if (b && b.label) {
        this._raiseEvent("3", {
          type: null,
          item: { label: b.label, value: b.value },
          label: b.label,
          value: b.value,
        });
      } else {
      ...
      for (var c = 0; c < b.length; c++) {
        ...
        if (
          g
            .toString()
            .toLowerCase()
            .indexOf(this.query.toString().toLowerCase()) === 0
        ) {
          h.push(e);
        } else {
    ...
    _render: function (f) {
      ...
      var g = function (n, k) {
        ...
        m.className = e.toThemeProperty(
          "jqx-item jqx-menu-item jqx-rc-all" + l
        );
    ...
    addHandlers: function () {
      ...
      if (c.isMaterialized() && this.input instanceof HTMLInputElement) {
        c.addHandler(c.input, "blur" + b, function () {
          c.onBlur();
        });
      }
      ...
      c.addHandler(c.$popup, "pointerdown" + b, function (d) {
        c.click(d);
      });
    },
    removeHandlers: function () {
      ...
      c.removeHandler(c.$popup, "pointerdown" + b);
    },
    move: function (b) {
      if (!this.opened) {
        return;
    ...
    mouseenter: function (b) {
      a(this._find("jqx-fill-state-pressed", this._popupHelper)).removeClass(
        this.toThemeProperty("jqx-fill-state-pressed")
      );
      b.currentTarget.className +=
        " " + this.toThemeProperty("jqx-fill-state-pressed");
    },
    _toPx: function (b) {
      if (typeof b === "number") {
