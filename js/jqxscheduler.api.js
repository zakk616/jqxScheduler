...
(function (a) {
  ...
  a.jqx.scheduler.utilities = {
      ...
      return (
        Math.ceil(
          (c - new Date(b.getFullYear(), 0, 1)) /
            a.jqx.scheduler.utilities.msPerDay
        ) + 1
      );
    },
    ...
    monthRange: function (c, d) {
      ...
      return [
        a.jqx.scheduler.utilities.getWeekday(b),
        a.jqx.scheduler.utilities.getMonthDays(b),
      ];
    },
    getMonthDays: function (b) {
      var c = b.getMonth();
      return c == 1 && a.jqx.scheduler.utilities.isLeapYear(b)
        ? 29
        : a.jqx.scheduler.utilities.monthDays[c];
    },
    ...
    untilStringToDate: function (d) {
      ...
      return new Date(
        Date.UTC(c[1], c[2] - 1, c[3], c[5] || 0, c[6] || 0, c[7] || 0)
      );
    },
    Time: function (b, e, c) {
      this.hour = b;
  ...
  a.jqx.scheduler.appointment = function () {
    ...
    c.toString = function (i) {
      ...
      return (
        ...
        "\n" +
        (c.recurrencePattern
          ? "RRULE:" + c.recurrencePattern.toString() + "\n"
          : "") +
        (c.recurrenceException && c.recurrenceException.length > 0
          ? "EXDATE:" + g() + "\n"
          : "") +
    ...
    c.anyOccurrences = function () {
      return (
        c.occurrenceEnumerator != null &&
        c.occurrenceEnumerator.getNextAppointment()
      );
    };
    ...
    c.getOccurrences = function (h, g) {
      ...
      var e = new a.jqx.scheduler.recurrentAppointmentsList(
        c,
        c.calendar,
        f,
        g,
  ...
  a.jqx.scheduler.recurrentAppointmentsList = function () {
    ...
    b.getOccurrences = function (c, e, d) {
      ...
      return new a.jqx.scheduler.recurrentAppointmentsList(c, b.calendar, e, d)
        .list;
    };
    b.current = function () {
    ...
    b.getNextAppointment = function (h) {
      ...
      for (var e = 0; e < d; e++) {
        ...
        h.currentTime = k;
        if (
          (h.to < k && h.to.addDays(f) >= k) ||
          (b.to < k && b.to.addDays(f) >= k)
        ) {
          b.currentTime = null;
          return true;
        }
        if (
          a.jqx.scheduler.utilities.getEndOfDay(h.to).addDays(f) < k ||
          a.jqx.scheduler.utilities.getEndOfDay(b.to).addDays(f) < k
        ) {
          b.currentTime = null;
          return false;
        }
  ...
  a.jqx.scheduler.recurrencePattern = function () {
            ...
            if (c.byyearday && c.byyearday.length > 0) {
              ...
              if (c.byweekno != null) {
                var p = function (n, k) {
                  ...
                  while (
                    a.jqx.scheduler.utilities.getWeekday(C.toDate()) != c.wkst
                  ) {
                    C = C.addDays(1);
                  }
                  return C;
    ...
    c.isDateInExceptionAppointment = function (d, e, f) {
      switch (c.freq) {
        ...
        default:
          return (
            d.year() == f.from.year() && d.dayOfYear() == f.from.dayOfYear()
          );
      }
    };
  ...
  a.extend(a.jqx._jqxScheduler.prototype, {
      ...
      if (w == "ical" || w == "ics") {
        if (q._resources.length > 1 && C && q.resourcesInMultipleICSFiles) {
          ...
          for (var E = 0; E < q._resources.length; E++) {
            ...
            var b = new Blob([p], { type: "application/calendar" });
            var d;
            if (d) {
              d(b, C + "_" + c + ".ics");
            } else {
      ...
      a.each(this.appointmentDataFields, function (j, m) {
        ...
        if (w == "html" || w == "xls" || w == "pdf") {
          var i = function (J, R, Q, K, P, M, L, N, O) {
            ...
            r[J]["background-color"] = q._getexportcolor(
    ...
    shadeColor: function (b, g) {
      ...
      return (
        ...
        (
          16777216 +
          (Math.round((c - e) * i) + e) * 65536 +
          (Math.round((c - d) * i) + d) * 256 +
          (Math.round((c - j) * i) + j)
        )
          .toString(16)
          .slice(1)
    ...
    _refreshColumns: function () {
      ...
      this.columnsheader =
        this.columnsheader || a('<div style="overflow: hidden;"></div>');
    ...
    _refreshColumnTitles: function () {
      ...
      var q = function (A, G, I) {
        ...
        for (var F = 0; F < E; F++) {
          ...
          if (L === "auto") {
            if (
              (x.getHours() == 0 && x.getMinutes() == 0) ||
              (x.getHours() == 12 && x.getMinutes() == 0)
            ) {
              var C = "hh tt";
            } else {
              var C = "hh:mm";
      ...
      for (var t = 0; t < this.tableColumns; t++) {
        switch (p) {
          case "dayView":
            ...
            d.push({});
            this.columns.records[d.length - 1].text = this._getDayName(
              g.dayOfWeek()
            );
            break;
          case "weekView":
      ...
      for (var v = 0; v < this.columns.records.length; v++) {
        ...
        var m =
          e.renderer != null
            ? e.renderer(l.escape_HTML(e.text), e.align, h)
            : l._rendercolumnheader(e.text, e.align, h, e);
        if (m == null) {
          m = l._rendercolumnheader(l.escape_HTML(e.text), e.align, h, l);
        }
        if (e.renderer != null) {
          m = a(m);
        }
    ...
    _editDialogLabel: function () {
      if (this.theme) {
        return (
          "jqx-scheduler-edit-dialog-label jqx-scheduler-edit-dialog-label-" +
          this.theme
        );
      }
    ...
    _editDialogField: function () {
      if (this.theme) {
        return (
          "jqx-scheduler-edit-dialog-field jqx-scheduler-edit-dialog-field-" +
          this.theme
        );
      }
    ...
    initRepeatPanels: function (p, i, c) {
      ...
      var o = function (H, A) {
        ...
        var D = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          u
        );
        var G = a(
          "<div style='top: 3px; position:relative; float:left;'><span style='margin-left:2px;'>" +
        ...
        var z = a("<div class='" + h._editDialogLabel() + "'></div>").appendTo(
          u
        );
        var y = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          u
        );
        var F = a(
          "<div style='top: 3px;  position:relative;  float:left;'><span style='margin-left:2px;'>" +
        ...
        var B = a("<div style='margin-left: 3px; float:left;'></div>").appendTo(
          y
        );
        B.jqxNumberInput({
          rtl: h.rtl,
        ...
        var v = a(
          "<div style='float: left; top: 3px;  margin-left: 5px; line-height:25px;'>" +
        ...
        var x = a("<div class='" + h._editDialogLabel() + "'></div>").appendTo(
          u
        );
        var w = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          u
        );
        var t = a(
          "<div style='top: 3px; position:relative; float:left;'><span style='margin-left:2px;'>" +
        ...
        var C = a("<div style='margin-left: 3px; float:left;'></div>").appendTo(
          w
        );
        C.jqxDateTimeInput({
          dropDownWidth: 220,
      ...
      o(m, "repeatEndPanel");
      var q = function () {
        var z = a("<div style='visibility: hidden;'></div>").appendTo(
          a(document.body)
        );
        var ad = a(
          "<div class='" +
        ...
        var ay = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          z
        );
        ...
        var E = a("<div style='visibility: hidden;'></div>").appendTo(
          a(document.body)
        );
        var ag = a(
          "<div class='" +
        ...
        var t = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          E
        );
        ...
        var Z = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          E
        );
        ...
        for (var aw = 0; aw < 7; aw++) {
          ...
          var B = a(
            "<div style='position:relative; top: 6px; float:left;'><span style='margin-left:2px;'>" +
              P +
              "</span></div>"
          );
          T.append(B);
        ...
        var U = a("<div style='visibility: hidden;'></div>").appendTo(
          a(document.body)
        );
        var av = a(
          "<div class='" +
        ...
        var M = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          U
        );
        ...
        var H = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          U
        );
        ...
        var O = a("<div class='" + h._editDialogLabel() + "'></div>").appendTo(
          U
        );
        var aj = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          U
        );
        var aa = a("<div style='float:left;'></div>").appendTo(aj);
        var G = a(
          "<div style='position:relative; top: 6px; float:left;'><span style='margin-left:2px;'></span></div>"
        ).appendTo(aa);
        G.jqxRadioButton({
          groupName: "month",
          width: 25,
        ...
        var S = a("<div style='margin-left: 5px; float:left;'></div>").appendTo(
          aa
        );
        var ac = new Array();
        for (var aw = 0; aw < 7; aw++) {
        ...
        var aq = a("<div style='visibility: hidden;'></div>").appendTo(
          a(document.body)
        );
        var R = a(
          "<div class='" +
        ...
        var ak = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          aq
        );
        ...
        var ah = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          aq
        );
        var X = a("<div style='float:left;'></div>").appendTo(ah);
        var af = a(
          "<div style='position:relative; top: 6px; float:left;'></span></div>"
        ).appendTo(X);
        af.jqxRadioButton({
          rtl: h.rtl,
          groupName: "year",
        ...
        var y = a("<div style='margin-left: 5px; float:left;'></div>").appendTo(
          X
        );
        y.jqxNumberInput({
          height: 25,
        ...
        var ae = a("<div class='" + h._editDialogLabel() + "'></div>").appendTo(
          aq
        );
        var s = a("<div class='" + h._editDialogField() + "'></div>").appendTo(
          aq
        );
        ...
        var I = a("<div style='margin-left: 5px; float:left;'></div>").appendTo(
          ar
        );
        ...
        var ap = new Array();
        var J = a(
          "<div style='line-height:25px; height: 25px; margin-left: 5px; float:left;'>" +
            h.schedulerLocalization.editDialogRepeatOfString +
            "</div>"
        ).appendTo(ar);
        var w = a("<div style='margin-left: 5px; float:left;'></div>").appendTo(
          ar
        );
        for (var aw = 0; aw < 12; aw++) {
          var ax = h.schedulerLocalization.months.names[aw];
    ...
    _initMenu: function () {
      ...
      if (this.host.jqxMenu) {
        ...
        this.menu = a(
          '<div id="menu.jqxscheduler' +
            this.element.id +
            '" style="white-space: nowrap; z-index: 9999999999999;"></div>'
        );
        this.host.append(this.menu);
        this.addHandler(
          a(window),
          "orientationchange.jqxscheduler" + this.element.id,
          function () {
        ...
        this.addHandler(
          a(window),
          "orientationchanged.jqxscheduler" + this.element.id,
          function () {
            c.menu.jqxMenu("close");
            c._hasOpenedMenu = false;
          }
        ...
        this.addHandler(this.menu, "open", function (e) {
          if (c.contextMenuOpen) {
            c.contextMenuOpen(
              c.menu,
              c.selectedJQXAppointment
                ? c.selectedJQXAppointment.boundAppointment
                : null,
              e
            );
          }
          c._raiseEvent("contextMenuOpen", {
            menu: c.menu,
            appointment: c.selectedJQXAppointment
              ? c.selectedJQXAppointment.boundAppointment
              : null,
          });
        ...
        this.addHandler(this.menu, "close", function (e) {
          ...
          if (
            ...
            document.activeElement.className.indexOf("jqx-menu") >= 0 &&
            !c.menuOpening
          ) {
            c.focus();
          }
    ...
    _initDialog: function (b, c) {
      ...
      if (
        b &&
        b.isRecurrentAppointment() &&
        !m.editRecurrenceDialog.jqxWindow("isOpen")
      ) {
        var l = m.host.coord();
        var o =
          l.top + m.host.height() / 2 - m.editRecurrenceDialog.height() / 2;
        var g =
          l.left + m.host.width() / 2 - m.editRecurrenceDialog.width() / 2;
      ...
      if (
        m.editDialogFields &&
        m.editDialogFields.resourceContainer &&
        m._resources.length > 0
      ) {
        var e = new Array();
      ...
      if (m._editDialog == null) {
        ...
        var p =
          b == null
            ? m.schedulerLocalization.editDialogCreateTitleString
            : m.schedulerLocalization.editDialogTitleString;
        var q = a(
          "<div><div>" +
            p +
            "</div><div id='dialog" +
        ...
        a(q).jqxWindow({
          ...
          initContent: function () {
            ...
            var ad = a(
              "<div class='" + m._editDialogField() + "'></div>"
            ).appendTo(A);
            ...
            var ai = a(
              "<div style='top: 8px; position:relative;'></div>"
            ).appendTo(ar);
            ...
            if (
              a.jqx.scheduler.utilities.getStartOfDay(d).equals(d) &&
              a.jqx.scheduler.utilities.getEndOfDay(h).equals(h)
            ) {
              m.editDialogFields.allDay.val(true);
            }
            if (
              m._views[m._view].type.indexOf("month") >= 0 ||
              (d && d.equals(h)) ||
              (h &&
                h.equals(a.jqx.scheduler.utilities.getEndOfDay(h)) &&
                d &&
                d.equals(a.jqx.scheduler.utilities.getStartOfDay(d)))
            ) {
              m.editDialogFields.allDay.val(true);
            }
            var w = a("<div></div>");
            ...
            u.push({
              displayName:
                m.schedulerLocalization.editDialogSelectTimeZoneString,
              id: null,
            });
            ...
            var D = a(
              "<textarea type='text' resizable='off' style='position:relative; top: 3px; padding:3px;'></textarea>"
            ).appendTo(O);
            D.jqxInput({
              rtl: m.rtl,
              height: 40,
            ...
            var I = function (aE) {
              ...
              var aF = "";
              aF +=
                "<div style='margin-top: 1px; float: left; border-radius: 3px; width: 96%; height: 20px; border: none; background:" +
                i +
                "; margin-left: 2%;'></div>";
              return aF;
            };
            var an = function (aG, aE) {
              ...
              var aF = "";
              aF +=
                "<div style='margin-top: 2px; float: left; border-radius: 3px; width: 96%; height: 20px; border: none; background:" +
                i +
                "; margin-left: 2%;'></div>";
              return aF;
            };
            F.jqxDropDownList({
              ...
              selectedIndex: -1,
              placeHolder:
                m.schedulerLocalization.editDialogColorPlaceHolderString,
            ...
            var ap = a(
              "<button style='margin-left: 5px; float:right;'>" +
                m.schedulerLocalization.editDialogCancelString +
                "</button>"
            ).appendTo(al);
            var aj = a(
              "<button style='margin-left: 5px; float:right;'>" +
                m.schedulerLocalization.editDialogDeleteString +
                "</button>"
            ).appendTo(al);
            var ak = a(
              "<button style='display: none; margin-left: 5px; float:right;'>" +
                m.schedulerLocalization.editDialogRepeatDeleteSeriesString +
                "</button>"
            ).appendTo(al);
            var J = a(
              "<button style='display: none; margin-left: 5px; float:right;'>" +
                m.schedulerLocalization.editDialogRepeatDeleteString +
                "</button>"
            ).appendTo(al);
            var aa = a(
              "<button style='margin-left: 5px; float:right;'>" +
                m.schedulerLocalization.editDialogSaveString +
                "</button>"
            ).appendTo(al);
            var aB = a(
              "<button style='display: none; margin-left: 5px; float:right;'>" +
                m.schedulerLocalization.editDialogRepeatSaveSeriesString +
                "</button>"
            ).appendTo(al);
            var s = a(
              "<button style='display: none; margin-left: 5px; float:right;'>" +
                m.schedulerLocalization.editDialogRepeatSaveString +
                "</button>"
            ).appendTo(al);
            var ax = 30;
            if (m.isTouchDevice()) {
            ...
            m.addHandler(s, "click", function () {
              if (!m.editAppointment.isException()) {
                if (m.editAppointment.rootAppointment != null) {
                  m.editAppointment.rootAppointment.exceptions.push(
                    m.editAppointment
                  );
                  m.editAppointment.rootAppointment.recurrenceException.push(
                    m.editAppointment.occurrenceFrom
                  );
                } else {
                  m.editAppointment.exceptions.push(m.editAppointment);
                  m.editAppointment.recurrenceException.push(
                    m.editAppointment.occurrenceFrom
                  );
                }
              } else {
                var aG = m.editAppointment.rootAppointment
                  ? m.editAppointment.rootAppointment.exceptions
                  : m.editAppointment.exceptions;
                for (var aF = 0; aF < aG.length; aF++) {
                  if (
                    aG[aF].occurrenceFrom.equals(
                      m.editAppointment.occurrenceFrom
                    )
                  ) {
              ...
              var aE = m._setAppointmentPropertiesFromDialog(
                m.editAppointment,
                "occurrence"
              );
              if (!aE) {
              ...
              if (m.editAppointment == null) {
                ...
                if (m.editAppointment.rootAppointment) {
                  ...
                  if (m.editAppointment.isRecurrentAppointment()) {
                    ...
                    i = m._setAppointmentPropertiesFromDialog(
                      m.editAppointment,
                      "none"
                    );
                    if (i) {
                      m.changedAppointments[m.editAppointment.id] = {
                        type: "Update",
                        appointment: m.editAppointment
                          ? m.editAppointment.boundAppointment
                          : null,
                      };
                      m._raiseEvent("appointmentChange", {
                        appointment: m.editAppointment.boundAppointment,
            ...
            m.addHandler(q, "close", function (i) {
              ...
              if (m.editDialogClose) {
                m.editDialogClose(
                  q,
                  m.editDialogFields,
                  m.editAppointment ? m.editAppointment.boundAppointment : null
                );
              }
      ...
      m.addHandler(m._editDialog, "open", function (t) {
        ...
        if (m.rtl) {
          m._editDialog
            .find(".jqx-scheduler-edit-dialog-label")
            .addClass(m.toThemeProperty("jqx-scheduler-edit-dialog-label-rtl"));
          m._editDialog
            .find(".jqx-scheduler-edit-dialog-field")
            .addClass(m.toThemeProperty("jqx-scheduler-edit-dialog-field-rtl"));
        ...
        if (m.editDialogFields) {
          ...
          if (b) {
            ...
            m._setAppointmentPropertiesToDialog(
              b,
              d,
              h,
              k ? k.resourceId : null
        ...
        if (j.repeatEndNever.val()) {
          ...
          if (j.repeatEndAfter.val()) {
            ...
            if (j.repeatEndOn.val()) {
              r.count = 1000;
              var h = new a.jqx.date(
                j.repeatEndOnValue.jqxDateTimeInput("getDate"),
                e.timeZone
              );
              r.to = h;
            }
    ...
    _setAppointmentPropertiesToDialog: function (e, h, d, g) {
      ...
      if (!e) {
        ...
        if (
          f._views[f._view].type.indexOf("month") >= 0 ||
          (h && h.equals(d)) ||
          (d &&
            d.equals(a.jqx.scheduler.utilities.getEndOfDay(d)) &&
            h &&
            h.equals(a.jqx.scheduler.utilities.getStartOfDay(h)))
        ) {
        ...
        switch (p) {
          ...
          case 4:
            ...
            if (r.bymonth && r.bymonth.length > 0) {
              t.repeatYearMonth.jqxDropDownList(
                "selectIndex",
                r.bymonth[0] - 1
              );
              t.repeatYearBool.val(true);
            ...
            if (!r.byyearday || (r.byyearday && r.byyearday.length == 0)) {
              t.repeatDayOfWeekMonth.jqxDropDownList(
                "selectIndex",
                r.bymonth[0] - 1
              );
          ...
          for (var f in e) {
            if (!d.hasOwnProperty(f)) {
              if (!d.hasOwnProperty(f.toLowerCase())) {
                b.host.remove();
                throw new Error(
                  "jqxScheduler: Invalid property name - " + f + "."
                );
              }
            }
          }
      ...
      switch (c.datatype) {
        ...
        default:
          ...
          if (c.localdata != null) {
            ...
            if (
              (!l.scheduler.autoBind && l.scheduler.isInitialized) ||
              l.scheduler.autoBind
            ) {
              e.dataBind();
            }
            var k = function () {
        ...
        if (f && f != "") {
          ...
          if (a.jqx.dataFormat.isNumber(d) && a.jqx.dataFormat.isNumber(c)) {
            ...
            if (a.jqx.dataFormat.isDate(d) && a.jqx.dataFormat.isDate(c)) {
              ...
              if (
                !a.jqx.dataFormat.isNumber(d) &&
                !a.jqx.dataFormat.isNumber(c)
              ) {
                d = String(d).toLowerCase();
                c = String(c).toLowerCase();
              }
      ...
      if (this.filters.length) {
        ...
        if (!this._filteredData) {
          if (
            ...
            (this.scheduler.source.hierarchy &&
              this.scheduler.source.hierarchy.length > 0)
          ) {
            var j = new Array();
            var g = function (n, o) {
      ...
      if (this.rows && j != "" && j != undefined && this.rows.length > 0) {
        ...
        for (var f = 1; f <= 100; f++) {
          ...
          if (!g) {
            if (
              this.scheduler &&
              this.scheduler.treeGrid &&
              this.scheduler.treescheduler.virtualModeCreateRecords
            ) {
