...
(function (a) {
  ...
  a.extend(a.jqx._jqxButton.prototype, {
    ...
    _addImage: function (c) {
      var g = this;
      if (
        g.element.nodeName.toLowerCase() == "input" ||
        g.element.nodeName.toLowerCase() == "button" ||
        g.element.nodeName.toLowerCase() == "div"
      ) {
        if (!g._img) {
          g.field = g.element;
    ...
    createInstance: function (d) {
      ...
      if (
        e.imgSrc != "" ||
        e.textPosition != "" ||
        (e.element.value && e.element.value.indexOf("<") >= 0) ||
        e.value != null
      ) {
        e.refresh();
      ...
      if (!e.overrideTheme) {
        e.buttonObj.addClass(
          e.toThemeProperty(a.jqx.cssroundedcorners(e.roundedCorners))
        );
        if (e.enableDefault) {
      ...
      if (e.isTouchDevice) {
        ...
        e.addHandler(
          a(document),
          a.jqx.mobile.getTouchEventName("touchend") + "." + e.element.id,
          function (h) {
            e.isPressed = false;
            e.refresh();
          }
      ...
      e.propertyChangeMap.theme = function (h, j, i, k) {
        ...
        if (i) {
          ...
          h.buttonObj.removeClass(
            h.toThemeProperty(a.jqx.cssroundedcorners(h.roundedCorners)) +
              "-" +
              i
          );
        }
    ...
    _removeHandlers: function () {
      ...
      if (b.isTouchDevice) {
        ...
        b.removeHandler(
          a(document),
          a.jqx.mobile.getTouchEventName("touchend") + "." + b.element.id
        );
      }
      b.mouseupfunc = null;
  ...
  a.extend(a.jqx._jqxRepeatButton.prototype, {
    ...
    createInstance: function (d) {
      ...
      var b = !c
        ? "mouseup." + this.base.element.id
        : "touchend." + this.base.element.id;
      var f = !c
        ? "mousedown." + this.base.element.id
        : "touchstart." + this.base.element.id;
  ...
  a.extend(a.jqx._jqxToggleButton.prototype, {
    ...
    createInstance: function (b) {
      ...
      c.propertyChangeMap.roundedCorners = function (d, f, e, g) {
        d.base.buttonObj.removeClass(
          d.toThemeProperty(a.jqx.cssroundedcorners(e))
        );
        d.base.buttonObj.addClass(
          d.toThemeProperty(a.jqx.cssroundedcorners(g))
        );
      };
      ...
      c.addHandler(
        a(document),
        "mouseup.togglebutton" + c.base.element.id,
        function (d) {
          if (!c.base.disabled) {
            c.refresh();
          }
    ...
    _removeHandlers: function () {
      ...
      this.removeHandler(
        a(document),
        "mouseup.togglebutton" + this.base.element.id
      );
    },
    toggle: function () {
