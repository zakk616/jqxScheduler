...
(function (a) {
  ...
  a.extend(a.jqx._jqxTooltip.prototype, {
    ...
    createInstance: function () {
      ...
      var b = "jqxtooltip" + c;
      this.IDArray.push({ tooltipID: b, tooltipHost: this.host });
    ...
    close: function (c) {
      ...
      var d = function () {
        ...
        e._raiseEvent("3");
        e._tooltipHelper.animate({ opacity: 0 }, c, function () {
    ...
    _setPosition: function (d) {
      var j = this,
        o = j._tooltip;
      if (
        (this._isOpen === false && parseFloat(o.style.opacity) === 0) ||
        this.changeContentFlag === true
      ) {
        if (
          !d &&
          (this.position === "mouse" || this.position === "mouseenter")
        ) {
          return;
        }
        ...
        switch (this.position) {
          case "top":
            this.tooltipOffset.left =
              this.hostOffset.left +
              this.hostWidth / 2 -
              this.tooltipWidth / 2 +
              this.offsetHorizontal;
            this.tooltipOffset.top =
              this.hostOffset.top -
              this.tooltipHeight -
              this.arrowSize +
              this.offsetVertical;
            ...
            n.style.borderWidth =
              this.arrowSize + "px " + this.arrowSize + "px 0px";
            this.tooltipArrowOffset.left =
              this.tooltipMainOffset.left + (f / 2 - this.arrowSize);
          ...
          case "bottom":
            ...
            n.className += " " + j.toThemeProperty("jqx-tooltip-arrow-t-b");
            n.style.borderWidth =
              "0 " + this.arrowSize + "px " + this.arrowSize + "px";
            this.tooltipArrowOffset.left =
              this.tooltipMainOffset.left + (f / 2 - this.arrowSize);
            this.tooltipArrowOffset.top =
              this.tooltipMainOffset.top - this.arrowSize;
            i.offset({
              top: this.tooltipArrowOffset.top,
              left: this.tooltipArrowOffset.left,
            });
          ...
          case "left":
            ...
            this.tooltipOffset.left =
              ...
              this.arrowSize +
              this.offsetHorizontal -
              (parseInt(c.borderLeftWidth, 10) +
                parseInt(c.borderRightWidth, 10));
            this.tooltipOffset.top =
              this.hostOffset.top +
              this.hostHeight / 2 -
            ...
            this.tooltipArrowOffset.top =
              this.tooltipMainOffset.top + l / 2 - this.arrowSize;
            i.offset({
              top: this.tooltipArrowOffset.top,
              left: this.tooltipArrowOffset.left,
            });
          ...
          case "right":
            ...
            n.style.borderWidth =
              ...
              "px 0px";
            this.tooltipArrowOffset.left =
              this.tooltipMainOffset.left - this.arrowSize;
            this.tooltipArrowOffset.top =
              this.tooltipMainOffset.top + e.offsetHeight / 2 - this.arrowSize;
            i.offset({
              top: this.tooltipArrowOffset.top,
              left: this.tooltipArrowOffset.left,
            });
          ...
          case "top-left":
            ...
            n.style.borderWidth =
              this.arrowSize + "px " + this.arrowSize + "px  0px";
            this.tooltipArrowOffset.left =
              this.tooltipMainOffset.left + f - 6 * this.arrowSize;
            this.tooltipArrowOffset.top = this.tooltipMainOffset.top + l;
            i.offset({
              top: this.tooltipArrowOffset.top,
              left: this.tooltipArrowOffset.left,
          ...
          case "top-right":
            ...
            n.style.borderWidth =
              this.arrowSize + "px " + this.arrowSize + "px  0px";
            this.tooltipArrowOffset.left =
              this.tooltipMainOffset.left + 4 * this.arrowSize;
            this.tooltipArrowOffset.top = this.tooltipMainOffset.top + l;
            i.offset({
              top: this.tooltipArrowOffset.top,
              left: this.tooltipArrowOffset.left,
          ...
          case "mouse":
              ...
              if (d.originalEvent) {
                ...
                if (d.originalEvent.touches && d.originalEvent.touches.length) {
                  ...
                  if (
                    ...
                    d.originalEvent.changedTouches.length
                  ) {
            ...
            break;
          case "mouseenter":
            var h = { top: d.pageY, left: d.pageX };
            if (
              h.top < this.hostOffset.top + 10 &&
              h.top > this.hostOffset.top - 10
            ) {
              this.tooltipOffset.left = h.left - this.tooltipWidth / 2;
              this.tooltipOffset.top =
                this.hostOffset.top - this.tooltipHeight - this.arrowSize;
              this._detectBrowserBounds();
              this.tooltipMainOffset = b.offset();
              j._removeClass(n, j.toThemeProperty("jqx-tooltip-arrow-l-r"));
              n.className += " " + j.toThemeProperty("jqx-tooltip-arrow-t-b");
              ...
              if (
                h.top < this.hostOffset.top + this.hostHeight + 10 &&
                h.top > this.hostOffset.top + this.hostHeight - 10
              ) {
                this.tooltipOffset.left = h.left - this.tooltipWidth / 2;
                this.tooltipOffset.top =
                  this.hostOffset.top + this.hostHeight + this.arrowSize;
                this._detectBrowserBounds();
                this.tooltipMainOffset = b.offset();
                j._removeClass(n, j.toThemeProperty("jqx-tooltip-arrow-l-r"));
                n.className += " " + j.toThemeProperty("jqx-tooltip-arrow-t-b");
                ...
                if (
                  h.left < this.hostOffset.left + 10 &&
                  h.left > this.hostOffset.left - 10
                ) {
                  if (window.getComputedStyle) {
                    c = window.getComputedStyle(e);
                  ...
                  j._removeClass(n, j.toThemeProperty("jqx-tooltip-arrow-t-b"));
                  n.className +=
                    " " + j.toThemeProperty("jqx-tooltip-arrow-l-r");
                  n.style.borderWidth =
                    this.arrowSize +
                    "px 0px " +
                    this.arrowSize +
                  ...
                  if (
                    ...
                    this.tooltipOffset.left =
                      this.hostOffset.left + this.hostWidth + this.arrowSize;
                    this.tooltipOffset.top = h.top - this.tooltipHeight / 2;
                    this._detectBrowserBounds();
                    this.tooltipMainOffset = b.offset();
                    j._removeClass(
                      n,
                      j.toThemeProperty("jqx-tooltip-arrow-t-b")
                    );
                    n.className +=
                      " " + j.toThemeProperty("jqx-tooltip-arrow-l-r");
                    n.style.borderWidth =
          ...
          case "default":
            this.tooltipOffset.left =
              this.hostOffset.left + this.hostWidth - this.defaultOffset;
            this.tooltipOffset.top =
              this.hostOffset.top + this.hostHeight + this.arrowSize;
            this._detectBrowserBounds();
            this.tooltipMainOffset = b.offset();
            ...
            case "hover":
              if (this.position === "mouse") {
                ...
                this.addHandler(b, "mouseleave.tooltip", function (f) {
                  ...
                  if (
                    parseInt(f.pageX, 10) < parseInt(g.left, 10) ||
                    parseInt(f.pageX, 10) > parseInt(g.left, 10) + e
                  ) {
                    c.close();
                  }
                  if (
                    parseInt(f.pageY, 10) < parseInt(g.top, 10) ||
                    parseInt(f.pageY, 10) > parseInt(g.top, 10) + d
                  ) {
                    c.close();
                  }
                });
                ...
                this.addHandler(b, "mouseleave.tooltip", function (g) {
                  ...
                  if (c.autoHide) {
                    ...
                    var d = c._tooltip.offsetHeight;
                    if (
                      parseInt(e, 10) < parseInt(j, 10) ||
                      parseInt(e, 10) > parseInt(j, 10) + f ||
                      parseInt(k, 10) < parseInt(i, 10) ||
                      parseInt(k, 10) > parseInt(i, 10) + d
                    ) {
                      c.close();
                    }
                  }
    ...
    _setTheme: function () {
      ...
      if (b._tooltip.className.indexOf("jqx-tooltip") === -1) {
        b._tooltip.className +=
          " " + b.toThemeProperty("jqx-tooltip jqx-popup");
        b._main.className +=
          " " +
          b.toThemeProperty(
            "jqx-widget jqx-fill-state-normal jqx-tooltip-main"
          );
        b._text.className +=
          " " +
          b.toThemeProperty(
            "jqx-widget jqx-fill-state-normal jqx-tooltip-text"
          );
        if (b._arrow) {
          b._arrow.className +=
            " " +
            b.toThemeProperty(
              "jqx-widget jqx-fill-state-normal jqx-tooltip-arrow"
            );
        }
      }
    },
    ...
    _detectBrowserBounds: function () {
      ...
      if (this.enableBrowserBoundsDetection) {
        if (
          this.tooltipOffset.top < this.documentTop &&
          this.tooltipOffset.left < 0
        ) {
          c.offset({ top: this.documentTop, left: this.documentLeft });
        } else {
          if (
            this.tooltipOffset.top < this.documentTop &&
            this.tooltipOffset.left + this.tooltipWidth >
              this.windowWidth + this.documentLeft
          ) {
            c.offset({
            ...
            if (this.tooltipOffset.top < this.documentTop) {
              ...
              if (
                this.tooltipOffset.top + this.tooltipHeight >
                  this.windowHeight + this.documentTop &&
                this.tooltipOffset.left < 0
              ) {
                c.offset({
                  top:
                    this.windowHeight + this.documentTop - this.tooltipHeight,
                ...
                if (
                  ...
                  c.offset({
                    top:
                      this.windowHeight + this.documentTop - this.tooltipHeight,
                    left:
                      this.windowWidth + this.documentLeft - this.tooltipWidth,
                  });
                } else {
                  if (
                    this.tooltipOffset.top + this.tooltipHeight >
    ...
    _checkBoundaries: function (b) {
      if (
        b.pageX >= this.hostOffset.left &&
        b.pageX <= this.hostOffset.left + this.hostWidth &&
        b.pageY >= this.hostOffset.top &&
        b.pageY <= this.hostOffset.top + this.hostHeight
      ) {
        return true;
      } else {
        return false;
